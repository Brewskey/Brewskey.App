angular.module('brewskey.services').factory('tapHub', [
  '$rootScope',
  '$q',
  'Hub',
  'Restangular',
  ...
  function($rootScope, $q, Hub, rest, $storage) {
    ...
    function reloadSet(type, tapId, kegId) {
      ...
      var id = type === 'keg-leaderboards' ? kegId : tapId;
    ...
    var hub = new Hub('tapHub', {
      ...
      listeners: {
        newPour: function(pour) {
          ...
          var userPours = _.find(leaderboard, function(item) {
