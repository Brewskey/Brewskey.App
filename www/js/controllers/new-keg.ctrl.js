angular.module('brewskey.controllers').controller('NewKegCtrl', [
  '$scope',
  'Restangular',
  '$stateParams',
  '$ionicModal',
  '$ionicHistory',
  '$state',
  function($scope, rest, $stateParams, $ionicModal, $ionicHistory, $state) {
    $scope.model = {
    ...
    $ionicModal
      .fromTemplateUrl('find-beer.html', {
        scope: $scope,
