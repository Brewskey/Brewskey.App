...
!(function() {
		...
		return c
					...
					return function(g, h, i) {
						...
						function l(a) {
							...
							if (
								...
								s && y && h.attr("title", a.local().format(s)),
								!d)
							) {
								var e = Math.abs(j().diff(a, "minute")),
									f = 3600;
								1 > e ? (f = 1) : 60 > e ? (f = 30) : 180 > e && (f = 300),
						...
						var o,
							...
							v = new Date().getTime(),
							w = i.amTimeAgo,
							x = "TIME" === h[0].nodeName.toUpperCase(),
							y = !h.attr("title");
						g.$watch(w, function(b) {
							return a(b) || "" === b
					...
					(this.changeLocale = function(d, e) {
						...
						(this.changeTimezone = function(c) {
							a.tz && a.tz.setDefault
								? (a.tz.setDefault(c), b.$broadcast("amMoment:timezoneChanged"))
								: d.warn(
						...
						(this.preprocessDate = function(b) {
							return (
								...
								e.preprocess
									? e.preprocess(b)
									: a(
											!isNaN(parseFloat(b)) && isFinite(b) ? parseInt(b, 10) : b
										)
							);
						});
				}
			...
			.filter("amCalendar", [
				...
				function(b, c, d) {
					function e(b) {
						if (a(b)) return "";
						var d = c.preprocessDate(b);
						return d.isValid() ? d.calendar() : "";
					}
	...
	"function" == typeof define && define.amd
		...
		: "undefined" != typeof module && module && module.exports
			? (c(require("angular"), require("moment")),
				(module.exports = "angularMoment"))
			: c(angular, ("undefined" != typeof global ? global : window).moment);
})();
