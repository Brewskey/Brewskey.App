...
(function() {
	...
	function s(t, r, e, u, o) {
		var i = -1,
			c = t.length;
		for (e || (e = D), o || (o = []); ++i < c; ) {
			var f = t[i];
			0 < r && e(f)
				? 1 < r ? s(f, r - 1, e, u, o) : n(o, f)
				: u || (o[o.length] = f);
		}
		return o;
	}
	...
	function g(n, t, r, e, u, o) {
		...
		return 2 & u ||
		((i = l && ln.call(n, "__wrapped__")),
		(f = c && ln.call(t, "__wrapped__")),
		!i && !f)
	...
	function _(n) {
		return typeof n == "function"
			? n
			: null == n ? X : (typeof n == "object" ? m : t)(n);
	}
	function j(n, t) {
		return n < t;
	}
	...
	function m(n) {
		...
		return function(r) {
			...
			for (r = Object(r); e--; ) {
				var u = t[e];
				if (!(u in r && y(n[u], r[u], Z, 3))) return false;
			}
			return true;
		};
	}
	...
	function x(n) {
		var t;
		return (
			(t = _n(t === Z ? n.length - 1 : t, 0)),
			function() {
				for (
					var r = arguments, e = -1, u = _n(r.length - t, 0), o = Array(u);
					++e < u;

				)
					o[e] = r[t + e];
				for (e = -1, u = Array(t + 1); ++e < t; ) u[e] = r[e];
	...
	function N(n, t, r, e) {
		...
		for (var u = -1, o = t.length; ++u < o; ) {
			var i = t[u],
				...
				i = c === Z ? n[i] : c,
				c = f[a];
			(ln.call(f, a) && J(c, i) && (i !== Z || a in f)) || (f[a] = i);
		}
		return r;
	}
	function S(n) {
		...
		function e() {
			for (
				var o = -1,
					...
					f = r.length,
					a = Array(f + i),
					l = this && this !== un && this instanceof e ? u : n;
				++c < f;
	...
	function B(n, t, r, e, u, o) {
		...
		for (var c = -1, f = true, a = 1 & u ? [] : Z; ++c < i; ) {
			var l = n[c],
				p = t[c];
			if (void 0 !== Z) {
				f = false;
	...
	function R(n, t, r, e, u, o) {
		...
		for (var l = f; l--; ) {
			var p = c[l];
			if (!(i ? p in t : ln.call(t, p))) return false;
		}
		for (a = true; ++l < f; ) {
			var p = c[l],
				s = n[p],
				h = t[p];
			if (void 0 !== Z || (s !== h && !r(s, h, e, u, o))) {
				a = false;
				break;
			}
			i || (i = "constructor" == p);
	...
	function $(n, t, r) {
		var e = n ? n.length : 0;
		(r = typeof r == "number" ? (0 > r ? _n(e + r, 0) : r) : 0),
			(r = (r || 0) - 1);
		for (var u = t === t; ++r < e; ) {
			var o = n[r];
	...
	function C(n, t, e) {
		return r(n, _(t), e, 3 > arguments.length, jn);
	}
	function G(n, t) {
		var r;
	...
	function M(n) {
		return (
			...
			P(n) &&
			ln.call(n, "callee") &&
			(!bn.call(n, "callee") || "[object Arguments]" == sn.call(n))
		);
	}
	function P(n) {
		var t;
	...
	function L(n) {
		return (
			typeof n == "string" ||
			(!wn(n) && H(n) && "[object String]" == sn.call(n))
		);
	}
	function Q(n) {
	...
	var Z,
		...
		_n = Math.max;
	(o.prototype = c(u.prototype)), (o.prototype.constructor = o);
	var jn = (function(n, t) {
			return function(r, e) {
				if (null == r) return r;
				if (!P(r)) return n(r, e);
		...
		On = (function(n) {
			...
			var e = n ? n.length : 0;
			if (!e) return -1;
			(r = null == r ? 0 : kn(r)), 0 > r && (r = _n(e + r, 0));
			n: {
		...
		Fn = S(function(n, t, r, e) {
			N(t, Dn(t), n, e);
		}),
		Bn = x(function(n) {
			return n.push(Z, i), Fn.apply(Z, n);
		}),
		Rn = gn,
		Dn = I,
		In = x(function(n, t) {
			return null == n ? {} : O(n, d(s(t, 1), mn));
		});
	(u.assignIn = Tn),
		(u.before = G),
		(u.bind = xn),
		(u.chain = function(n) {
			return (n = u(n)), (n.__chain__ = true), n;
		}),
		...
		(u.pick = In),
		(u.slice = function(n, t, r) {
			var e = n ? n.length : 0;
			return (r = r === Z ? e : +r), e ? A(n, null == t ? 0 : +t, r) : [];
		}),
		(u.sortBy = function(n, r) {
			var e = 0;
			return (
				(r = _(r)),
				d(
		...
		(u.toArray = function(n) {
			return P(n) ? (n.length ? E(n) : []) : W(n);
		}),
		(u.values = W),
		(u.extend = Tn),
		Y(u, u),
		(u.clone = function(n) {
			return V(n) ? (wn(n) ? E(n) : N(n, gn(n))) : n;
		}),
		(u.escape = function(n) {
			return (n = Q(n)) && rn.test(n) ? n.replace(tn, cn) : n;
		}),
		(u.every = function(n, t, r) {
			return (t = r ? Z : t), a(n, _(t));
		}),
		(u.find = On),
		(u.forEach = z),
		(u.has = function(n, t) {
		...
		(u.isEmpty = function(n) {
			return P(n) && (wn(n) || L(n) || U(n.splice) || M(n))
				? !n.length
				: !gn(n).length;
		}),
		...
		(u.max = function(n) {
			return n && n.length ? l(n, X, b) : Z;
		}),
		(u.min = function(n) {
			return n && n.length ? l(n, X, j) : Z;
		}),
		(u.noConflict = function() {
			return un._ === this && (un._ = hn), this;
		}),
		(u.noop = function() {}),
		(u.reduce = C),
		(u.result = function(n, t, r) {
			return (
				(t = null == n ? Z : n[t]), t === Z && (t = r), U(t) ? t.call(n) : t
			);
		}),
		(u.size = function(n) {
			return null == n ? 0 : ((n = P(n) ? n : gn(n)), n.length);
		}),
		(u.some = function(n, t, r) {
			return (t = r ? Z : t), w(n, _(t));
		}),
		...
		jn(
			...
			function(n) {
				...
				u.prototype[n] = function() {
					...
					if (e && !this.__chain__) {
						var u = this.value();
						return t.apply(wn(u) ? u : [], n);
					}
					return this[r](function(r) {
						return t.apply(wn(r) ? r : [], n);
					});
				};
			}
		),
		...
		typeof define == "function" && typeof define.amd == "object" && define.amd
			...
			: on ? (((on.exports = u)._ = u), (en._ = u)) : (un._ = u);
}.call(this));
