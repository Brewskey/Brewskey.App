...
!(function() {
	...
	function r(t) {
		return t.isIonicTap || p(t)
			? null
			: B
				? (t.stopPropagation(),
					ionic.Platform.isEdge() ||
						(ionic.tap.isTextInput(t.target) && K === t.target) ||
						b(t.target.tagName) ||
						ionic.tap.isVideo(t.target) ||
						t.preventDefault(),
					!1)
				: (($ = !1),
					(q = ionic.tap.pointerCoord(t)),
					e("mousemove"),
	...
	function o(t) {
		return _(t)
			? (e("mousemove", !1), ionic.activator.end(), ($ = !0), !1)
			: void 0;
	}
	function s(t) {
		if (
	...
	function l(e) {
		p(e) ||
			(u(),
			_(e) || (t(e), b(e.target.tagName) && e.preventDefault()),
			(K = e.target),
			d());
	}
	function c(t) {
	...
	function h(e) {
		...
		var t = !1;
		"SELECT" == e.tagName
			? (n("mousedown", e, 0, 0), e.focus && e.focus(), (t = !0))
			: v() === e
				? (t = !0)
				: /^(input|textarea|ion-label)$/i.test(e.tagName) || e.isContentEditable
					? ((t = !0), e.focus && e.focus(), (e.value = e.value), B && (U = e))
					: f(),
			t && (v(e), ionic.trigger("ionic.focusin", { target: e }, !0));
	}
	function f() {
		var e = v();
		e &&
	...
	function m(e) {
		B &&
			ionic.tap.isTextInput(v()) &&
			ionic.tap.isTextInput(U) &&
			U !== e.target &&
			(U.focus(), (U = null)),
	...
	function S() {
		ionic.keyboard.isInitialized ||
			(V()
				? (window.addEventListener("native.keyboardshow", pe),
					window.addEventListener("native.keyboardhide", x))
				: document.body.addEventListener("focusout", x),
			document.body.addEventListener("ionic.focusin", ue),
			document.body.addEventListener("focusin", ue),
			window.navigator.msPointerEnabled
				? document.removeEventListener("MSPointerDown", S)
	...
	function E(e) {
		return (
			...
			(ne = ionic.DomUtil.getParentWithClass(e.target, de))
				? ((ee = e.target),
					ne.classList.contains("overflow-scroll") ||
					...
					void (ionic.keyboard.isOpen || V()
						? ionic.keyboard.isOpen && I()
						: L(I, !0)))
				: (ee && (te = ee), void (ee = null))
		);
	}
	function x() {
		clearTimeout(re),
	...
	function D() {
		(ionic.keyboard.isLandscape = !ionic.keyboard.isLandscape),
			...
			ionic.Platform.isAndroid() &&
				(ionic.keyboard.isOpen && V() ? (le = !0) : L(O, !1));
	}
	function M(e) {
		...
		return (
			(n =
				ionic.Platform.isAndroid() && ionic.Platform.version() < 4.4
					? 30
					: ionic.Platform.isAndroid() ? 10 : 1),
			(ie = setInterval(function() {
				(a = G()),
					(!(++i < n) || ((N(a) || z(a)) && ionic.keyboard.height)) &&
						(V() || (ionic.keyboard.height = Math.abs(r - window.innerHeight)),
	...
	function P() {
		clearTimeout(re),
			...
			(ee || te) && ionic.trigger("resetScrollView", { target: ee || te }, !0),
			ionic.requestAnimationFrame(function() {
	...
	function k() {
		...
		return ionic.Platform.isIOS()
			? ionic.keyboard.isLandscape
				? 206
				: ionic.Platform.isWebView() ? 260 : 216
			: 275;
	}
	function N(e) {
	...
	function O() {
		(le = !1),
			(ae = G()),
			ionic.keyboard.isLandscape && !se
				? (se = ae)
				: ionic.keyboard.isLandscape || oe || (oe = ae),
			ee && ionic.trigger("resetScrollView", { target: ee }, !0),
			ionic.keyboard.isOpen && ionic.tap.isTextInput(ee) && I();
	}
	function A() {
		var e = G();
		...
		delete fe.height,
			...
			n.isIPad()
				? i > 7
					? delete fe.width
					: n.isWebView()
						? 90 == o ? (fe.height = "0") : 7 == i && (fe.height = a)
						: 7 > i && (fe.height = "0")
				: n.isIOS() &&
					(n.isWebView()
						? i > 7
							? delete fe.width
							: 7 > i ? t && (fe.height = "0") : 7 == i && (fe.height = a)
						: 7 > i && t && (fe.height = "0")),
			(e !== fe.width || t !== fe.height) && Y();
	}
	function Y() {
		var e,
			t = [];
	...
	(window.ionic = window.ionic || {}),
		...
		(function(e, t, n) {
			...
			a || t.addEventListener("DOMContentLoaded", i),
				(e._rAF = (function() {
					return (
			...
			(n.DomUtil = {
				...
				getChildIndex: function(e, t) {
					if (t)
						for (
							var n, i = e.parentNode.children, r = 0, a = 0, o = i.length;
							o > r;
							r++
						)
				...
				blurAll: function() {
					return t.activeElement && t.activeElement != t.body
				...
				cachedAttr: function(e, t, n) {
					if (((e = (e && e.length && e[0]) || e), e && e.setAttribute)) {
						...
						return (
							arguments.length > 2
								? e[i] !== n && (e.setAttribute(t, n), (e[i] = n))
								: "undefined" == typeof e[i] && (e[i] = e.getAttribute(t)),
							e[i]
						);
					}
				},
		...
		(function(e) {
			(e.CustomEvent = (function() {
				...
				(e.EventController = {
					...
					on: function(t, n, i) {
						for (
							var r = i || window, a = 0, o = this.VIRTUALIZED_EVENTS.length;
							o > a;
							a++
						)
			...
			function t() {
				if (!e.Gestures.READY) {
					...
					for (var t in e.Gestures.gestures)
						e.Gestures.gestures.hasOwnProperty(t) &&
							e.Gestures.detection.register(e.Gestures.gestures[t]);
			...
			(e.Gesture = function(t, n) {
				...
				(e.Gestures.Instance.prototype = {
					...
					trigger: function(t, n) {
						...
						var r = this.element;
						return (
							e.Gestures.utils.hasParent(n.target, r) && (r = n.target),
							r.dispatchEvent(i),
							this
						);
					},
			...
			(e.Gestures.event = {
				...
				onTouch: function(t, a, o) {
					...
					this.bindDom(t, e.Gestures.EVENT_TYPES[a], function(l) {
						...
						if (!c.match(/mouse/) || !r) {
							c.match(/touch/) ||
							c.match(/pointerdown/) ||
							(c.match(/mouse/) && 1 === l.which)
								? (i = !0)
								: c.match(/mouse/) && 1 !== l.which && (i = !1),
								c.match(/touch|pointer/) && (r = !0);
							var d = 0;
							i &&
								(e.Gestures.HAS_POINTEREVENTS && a != e.Gestures.EVENT_END
									? (d = e.Gestures.PointerEvent.updatePointer(a, l))
									: c.match(/touch/)
										? (d = l.touches.length)
										: r || (d = c.match(/up/) ? 0 : 1),
								d > 0 && a == e.Gestures.EVENT_END
									? (a = e.Gestures.EVENT_MOVE)
									: d || (a = e.Gestures.EVENT_END),
								(d || null === n) && (n = l),
								o.call(
									e.Gestures.detection,
									s.collectEventData(t, a, s.getTouchList(n, a), l)
								),
								e.Gestures.HAS_POINTEREVENTS &&
				...
				getTouchList: function(t) {
					return e.Gestures.HAS_POINTEREVENTS
						...
						: t.touches ? t.touches : ((t.identifier = 1), [t]);
				},
				...
				(e.Gestures.PointerEvent = {
					...
					updatePointer: function(t, n) {
						return (
							t == e.Gestures.EVENT_END
								? (this.pointers = {})
								: ((n.identifier = n.pointerId),
					...
					matchType: function(t, n) {
						...
						var i = {};
						return (
							(i[e.Gestures.POINTER_MOUSE] =
								n.pointerType == n.MSPOINTER_TYPE_MOUSE ||
								n.pointerType == e.Gestures.POINTER_MOUSE),
							(i[e.Gestures.POINTER_TOUCH] =
								n.pointerType == n.MSPOINTER_TYPE_TOUCH ||
								n.pointerType == e.Gestures.POINTER_TOUCH),
							(i[e.Gestures.POINTER_PEN] =
								n.pointerType == n.MSPOINTER_TYPE_PEN ||
								n.pointerType == e.Gestures.POINTER_PEN),
							i[t]
						);
					},
					getEvents: function() {
				...
				(e.Gestures.utils = {
					...
					isVertical: function(t) {
						return (
							t == e.Gestures.DIRECTION_UP || t == e.Gestures.DIRECTION_DOWN
						);
					},
				...
				(e.Gestures.detection = {
					...
					detect: function(t) {
						...
						for (
							var n = this.current.inst.options,
								i = 0,
							...
							if (
								!this.stopped &&
								n[a.name] !== !1 &&
								a.handler.call(a, t, this.current.inst) === !1
							) {
								this.stopDetect();
								break;
							}
						...
						return (
							...
							t.eventType == e.Gestures.EVENT_END &&
								!t.touches.length - 1 &&
								this.stopDetect(),
							t
						);
					...
					extendEventData: function(t) {
						...
						if (
							n &&
							(t.touches.length != n.touches.length || t.touches === n.touches)
						) {
							n.touches = [];
								...
								clearTimeout(this.timer),
									...
									(this.timer = setTimeout(function() {
										"hold" == e.Gestures.detection.current.name &&
											(e.tap.cancelClick(), n.trigger("hold", t));
									}, n.options.hold_timeout));
								break;
							case e.Gestures.EVENT_MOVE:
								t.distance > n.options.hold_threshold &&
									clearTimeout(this.timer);
								break;
				...
				(e.Gestures.gestures.Tap = {
					...
					handler: function(t, n) {
						if (
							t.eventType == e.Gestures.EVENT_END &&
							"touchcancel" != t.srcEvent.type
						) {
							var i = e.Gestures.detection.previous,
								r = !1;
							if (
								t.deltaTime > n.options.tap_max_touchtime ||
								t.distance > n.options.tap_max_distance
							)
								return;
							i &&
								"tap" == i.name &&
								t.timeStamp - i.lastEvent.timeStamp <
									n.options.doubletap_interval &&
								t.distance < n.options.doubletap_distance &&
								(n.trigger("doubletap", t), (r = !0)),
								(!r || n.options.tap_always) &&
				...
				(e.Gestures.gestures.Swipe = {
					...
					handler: function(t, n) {
						if (t.eventType == e.Gestures.EVENT_END) {
							if (
								n.options.swipe_max_touches > 0 &&
								t.touches.length > n.options.swipe_max_touches
							)
								return;
							(t.velocityX > n.options.swipe_velocity ||
								t.velocityY > n.options.swipe_velocity) &&
				...
				(e.Gestures.gestures.Drag = {
					...
					handler: function(t, n) {
						if (
							("touchstart" == t.srcEvent.type || "touchend" == t.srcEvent.type
								? (this.preventedFirstMove = !1)
								: this.preventedFirstMove ||
									"touchmove" != t.srcEvent.type ||
									(n.options.prevent_default_directions.length > 0 &&
										-1 !=
											n.options.prevent_default_directions.indexOf(
												t.direction
											) &&
							...
							return (
								n.trigger(this.name + "end", t), void (this.triggered = !1)
							);
						if (
							!(
								...
								case e.Gestures.EVENT_MOVE:
									...
									t.drag_locked_to_axis &&
										...
										((n.options.drag_block_vertical &&
											e.Gestures.utils.isVertical(t.direction)) ||
						...
						if (!(t.touches.length < 2))
							...
							t.eventType)) {
								...
								case e.Gestures.EVENT_MOVE:
									...
									if (
										i < n.options.transform_min_scale &&
										r < n.options.transform_min_rotation
									)
										return;
									(e.Gestures.detection.current.name = this.name),
										this.triggered ||
				...
				(e.Gestures.gestures.Touch = {
					...
					handler: function(t, n) {
						...
						t.pointerType == e.Gestures.POINTER_MOUSE
							? void t.stopDetect()
							: (n.options.prevent_default && t.preventDefault(),
								void (
									t.eventType == e.Gestures.EVENT_START &&
									n.trigger(this.name, t)
								));
					}
				}),
		...
		(function(e, t, n) {
			...
			function a() {
				f.isWebView() ? t.addEventListener("deviceready", o, !1) : o(),
					s && e.removeEventListener("load", a, !1);
			}
			function o() {
				(f.isReady = !0), f.detect();
				for (var e = 0; e < v.length; e++) v[e]();
				(v = []),
					n.trigger("platformready", { target: t }),
					h(function() {
			...
			var s,
				...
				f = (n.Platform = {
					...
					_checkPlatforms: function() {
						...
						var t = "a";
						f.isWebView()
							? (f.platforms.push("webview"),
								e.cordova || e.PhoneGap || e.phonegap
									? f.platforms.push("cordova")
									: "object" == typeof e.forge && f.platforms.push("trigger"))
							: f.platforms.push("browser"),
							f.isIPad() && f.platforms.push("ipad");
						var n = f.platform();
						if (n) {
							f.platforms.push(n);
							var i = f.version();
							if (i) {
								...
								r.indexOf(".") > 0 ? (r = r.replace(".", "_")) : (r += "_0"),
									f.platforms.push(n + r.split("_")[0]),
									f.platforms.push(n + r),
									f.isAndroid() && 4.4 > i
										? (t = 4 > i ? "c" : "b")
										: f.isWindowsPhone() && (t = "b");
							}
						}
						f.setGrade(t);
					},
						...
						m =
							"undefined" != typeof e && null !== e && e.length
								...
								: i("ionicplatform")
									...
									: f.ua.indexOf("Edge") > -1
										? u
										: f.ua.indexOf("Windows Phone") > -1
											? d
											: f.ua.indexOf("Android") > 0
												? c
												: /iPhone|iPad|iPod/.test(f.ua)
													? l
					...
					setVersion: function(e) {
						...
						n[t] &&
							((e = f.ua.match(n[t])),
							e && e.length > 2 && (g = parseFloat(e[1] + "." + e[2])));
					},
					is: function(e) {
								...
								h(function() {
									f._showStatusBar
										? (e.StatusBar && e.StatusBar.show(),
											t.body.classList.remove("status-bar-hide"))
					...
					fullScreen: function(e, i) {
						(f.isFullScreen = e !== !1),
							n.DomUtil.ready(function() {
								h(function() {
									f.isFullScreen
										? t.body.classList.add("fullscreen")
										: t.body.classList.remove("fullscreen");
								}),
									f.showStatusBar(i === !0);
							});
					}
			...
			r(),
				"complete" === t.readyState
					? a()
					: ((s = !0), e.addEventListener("load", a, !1));
		})(window, document, ionic),
		(function(e, t) {
			"use strict";
			(t.CSS = {}),
				...
				(function() {
					...
					window.navigator.pointerEnabled
						...
						: window.navigator.msPointerEnabled &&
							...
							(i = "MSPointerUp"),
							(r = "MSPointerCancel")),
						(t.EVENTS.touchstart = e),
						(t.EVENTS.touchmove = n),
						(t.EVENTS.touchend = i),
						(t.EVENTS.touchcancel = r);
				})(),
	...
	(ionic.tap = {
				...
				window.navigator.pointerEnabled
					...
					: window.navigator.msPointerEnabled
						? (e("MSPointerDown"),
							...
							e("MSPointerCancel"),
							(j = "MSPointerMove"))
						: (e("touchstart"), e("touchend"), e("touchcancel")),
				e("focusin"),
				e("focusout"),
				function() {
			...
			return (
				...
				"true" ==
					(e.target.dataset
						...
						: e.target.getAttribute("data-prevent-scroll")) ||
		...
		isDateInput: function(e) {
			return (
				!!e &&
				"INPUT" == e.tagName &&
				/^(date|time|datetime-local|month|week)$/i.test(e.type)
			);
		},
		isVideo: function(e) {
		...
		isKeyboardElement: function(e) {
			return !ionic.Platform.isIOS() || ionic.Platform.isIPad()
				? ionic.tap.isTextInput(e) && !ionic.tap.isDateInput(e)
				: ionic.tap.isTextInput(e) || (!!e && "SELECT" == e.tagName);
		},
				...
				ionic.requestAnimationFrame(function() {
					...
					if (ionic.tap.isTextInput(t) && !ionic.tap.isDateInput(t)) {
						...
						(n.value = t.value),
							...
							(n.readOnly = !0),
							t.isContentEditable &&
								((n.contentEditable = t.contentEditable),
		...
		requiresNativeClick: function(e) {
			...
			("A" == e.tagName ||
				...
				("INPUT" == e.tagName && ("button" == e.type || "submit" == e.type)))
				? !0
				: !e ||
					e.disabled ||
					/^(file|range)$/i.test(e.type) ||
					/^(object|video)$/i.test(e.tagName) ||
					ionic.tap.isLabelContainingFileInput(e)
					? !0
					: ionic.tap.isElementTapDisabled(e);
		},
		...
		isElementTapDisabled: function(e) {
			if (e && 1 === e.nodeType)
				for (var t = e; t; ) {
					if (t.getAttribute && "true" == t.getAttribute("data-tap-disabled"))
						return !0;
					t = t.parentElement;
				}
			return !1;
				...
				start: function(e) {
					...
					(n > 0 && 30 > n) ||
						t.requestAnimationFrame(function() {
							if (
								!(
									(t.scroll && t.scroll.isScrolling) ||
									t.tap.requiresNativeClick(e.target)
								)
							) {
								for (
									var n, r = e.target, o = 0;
									6 > o && (r && 1 === r.nodeType);
									o++
								) {
									...
									if (
										"ION-CONTENT" == r.tagName ||
										(r.classList && r.classList.contains("pane")) ||
										"BODY" == r.tagName
									)
										break;
									r = r.parentElement;
				...
				throttle: function(e, t, n) {
					...
					return function() {
						...
						return (
							...
							(r = arguments),
							0 >= d
								? (clearTimeout(o), (o = null), (s = c), (a = e.apply(i, r)))
								: o || n.trailing === !1 || (o = setTimeout(l, d)),
							a
						);
					};
				},
				...
				reconnectScope: function(e) {
					if (e && e.$root !== e && e.$$disconnected) {
						...
						(e.$$disconnected = !1),
							...
							t.$$childHead
								? ((t.$$childTail.$$nextSibling = e), (t.$$childTail = e))
								: (t.$$childHead = t.$$childTail = e);
					}
				},
	...
	(ionic.keyboard = {
		...
		disable: function() {
			V()
				? (window.removeEventListener("native.keyboardshow", pe),
					window.removeEventListener("native.keyboardhide", x))
				: document.body.removeEventListener("focusout", x),
				document.body.removeEventListener("ionic.focusin", ue),
				document.body.removeEventListener("focusin", ue),
		...
		ionic.Platform.ready(function() {
			A(),
				...
				setTimeout(A, 999),
				window.navigator.msPointerEnabled
					? document.addEventListener("MSPointerDown", S, !1)
	...
	(ionic.viewport = {
		...
		(function(e) {
			...
			(e.views.View = function() {
				...
				e.extend(e.views.View.prototype, { initialize: function() {} });
		})(window.ionic);
	var me = { effect: {} };
	!(function(e) {
		var t =
			...
			start: function(e, o, s, l, c, d) {
				...
				var _ = function(a) {
					var g = a !== !0,
						v = t();
					if (!r[m] || (o && !o(m)))
						return (r[m] = null), void (s && s(n - f / ((v - u) / i), m, !1));
					if (g)
						for (
							var w = Math.round((v - p) / (i / n)) - 1, T = 0;
							T < Math.min(w, 4);
							T++
						)
							_(!0), f++;
					...
					var b = c ? c(h) : h;
					(e(b, v, g) !== !1 && 1 !== h) || !g
						? g && ((p = v), me.effect.Animate.requestAnimationFrame(_, d))
						: ((r[m] = null),
							s && s(n - f / ((v - u) / i), m, 1 === h || null == l));
				};
			...
			(e.views.Scroll = e.views.View.inherit({
				initialize: function(n) {
					...
					(i.__container = n.el),
						...
						setTimeout(function() {
							i.__container &&
								i.__content &&
								((i.__container.scrollTop = 0), (i.__content.scrollTop = 0));
						}),
						(i.options = {
							scrollingX: !1,
							scrollbarX: !0,
							...
							getContentWidth: function() {
								return Math.max(
									i.__content.scrollWidth,
									i.__content.offsetWidth
								);
							},
							getContentHeight: function() {
								return Math.max(
									i.__content.scrollHeight,
									i.__content.offsetHeight + 2 * i.__content.offsetTop
								);
							}
						});
					for (var r in n) i.options[r] = n[r];
					(i.hintResize = e.debounce(
						function() {
							i.resize();
						},
						1e3,
						...
						(i.onScroll = function() {
							e.scroll.isScrolling
								? (clearTimeout(i.scrollTimer),
									(i.scrollTimer = setTimeout(i.setScrollStop, 80)))
								: setTimeout(i.setScrollStart, 50);
						}),
						(i.freeze = function(e) {
							return (
								arguments.length && (i.options.freeze = e), i.options.freeze
							);
						}),
						(i.freezeShut = i.freeze),
						(i.setScrollStart = function() {
							(e.scroll.isScrolling =
								Math.abs(e.scroll.lastTop - i.__scrollTop) > 1),
								clearTimeout(i.scrollTimer),
								(i.scrollTimer = setTimeout(i.setScrollStop, 80));
						}),
				...
				__initEventHandlers: function() {
					...
					var n,
						...
						r = i.__container;
					if (
						((i.scrollChildIntoView = function(t) {
							...
							t.detail.isElementUnderKeyboard &&
								e.requestAnimationFrame(function() {
									(r.scrollTop = 0),
									...
									var s = 0.5 * n,
										...
										d = c + s;
									d > 0 &&
										(e.Platform.isIOS() && e.tap.cloneFocusedInput(r, i),
										i.scrollBy(0, d, !0),
										i.onScroll());
								}),
								t.stopPropagation();
						...
						(i.touchStart = function(n) {
							if (
								((i.startCoordinates = e.tap.pointerCoord(n)),
								!e.tap.ignoreScrollStart(n))
							) {
								if (
									((i.__isDown = !0),
									e.tap.containsOrIsTextInput(n.target) ||
						...
						(i.touchMove = function(n) {
							if (
								!(
									i.options.freeze ||
									!i.__isDown ||
									(!i.__isDown && n.defaultPrevented) ||
									("TEXTAREA" === n.target.tagName &&
										n.target.parentElement.querySelector(":focus"))
								)
							) {
								if (
									!i.__hasStarted &&
								...
								if (i.startCoordinates) {
									...
									i.__isSelectable &&
										e.tap.isTextInput(n.target) &&
										Math.abs(i.startCoordinates.x - a.x) > 20 &&
										((i.__enableScrollY = !1), (i.__isSelectable = !0)),
										i.__enableScrollY &&
											Math.abs(i.startCoordinates.y - a.y) > 10 &&
											((i.__isSelectable = !1), e.tap.cloneFocusedInput(r, i));
								}
						...
						(i.touchEnd = function(t) {
							i.__isDown &&
								...
								i.__isDragging ||
									i.__isDecelerating ||
									i.__isAnimating ||
									e.tap.removeClonedInputs(r, i));
						}),
						(i.mouseWheel = e.animationFrameThrottle(function(t) {
							var n = e.DomUtil.getParentOrSelfWithClass(
								t.target,
								"ionic-scroll"
							);
							i.options.freeze ||
								...
								(i.hintResize(),
								i.scrollBy(
									(t.wheelDeltaX || t.deltaX || 0) / i.options.wheelDampen,
									(-t.wheelDeltaY || t.deltaY || 0) / i.options.wheelDampen
								),
						...
						r.addEventListener("touchstart", i.touchStart, !1),
							i.options.preventDefault &&
								r.addEventListener("touchmove", i.touchMoveBubble, !1),
						...
						r.addEventListener("pointerdown", i.touchStart, !1),
							i.options.preventDefault &&
								r.addEventListener("pointermove", i.touchMoveBubble, !1),
						...
						r.addEventListener("MSPointerDown", i.touchStart, !1),
							i.options.preventDefault &&
								r.addEventListener("MSPointerMove", i.touchMoveBubble, !1),
						...
						(i.mouseDown = function(n) {
							...
							(i.mouseMove = function(e) {
								i.options.freeze ||
									...
									(i.doTouchMove(t(e), e.timeStamp), (a = !0));
							}),
							...
							i.options.preventDefault &&
								r.addEventListener("mousemove", i.mouseMoveBubble, !1),
				...
				__createScrollbar: function(e) {
					...
					return (
						(n.className = "scroll-bar-indicator scroll-bar-fade-out"),
						"h" == e
							? (t.className = "scroll-bar scroll-bar-h")
							: (t.className = "scroll-bar scroll-bar-v"),
						t.appendChild(n),
						t
					);
				},
				__createScrollbars: function() {
					var e,
						t,
						n = this;
					n.options.scrollingX &&
						((e = { el: n.__createScrollbar("h"), sizeRatio: 1 }),
						(e.indicator = e.el.children[0]),
						n.options.scrollbarX && n.__container.appendChild(e.el),
						(n.__indicatorX = e)),
						n.options.scrollingY &&
							((t = { el: n.__createScrollbar("v"), sizeRatio: 1 }),
				...
				__resizeScrollbars: function() {
					...
					if (t.__indicatorX) {
						var n = Math.max(
							Math.round(t.__clientWidth * t.__clientWidth / t.__contentWidth),
							20
						);
						n > t.__contentWidth && (n = 0),
							n !== t.__indicatorX.size &&
								e.requestAnimationFrame(function() {
							...
							(t.__indicatorX.sizeRatio = t.__maxScrollLeft
								? t.__indicatorX.maxPos / t.__maxScrollLeft
								: 1);
					}
					if (t.__indicatorY) {
						var i = Math.max(
							Math.round(
								t.__clientHeight * t.__clientHeight / t.__contentHeight
							),
							20
						);
						i > t.__contentHeight && (i = 0),
							i !== t.__indicatorY.size &&
								e.requestAnimationFrame(function() {
									t.__indicatorY &&
										(t.__indicatorY.indicator.style.height = i + "px");
								}),
							(t.__indicatorY.size = i),
							(t.__indicatorY.minScale = t.options.minScrollbarSizeY / i),
							(t.__indicatorY.maxPos = t.__clientHeight - i),
							(t.__indicatorY.sizeRatio = t.__maxScrollTop
								? t.__indicatorY.maxPos / t.__maxScrollTop
								: 1);
					}
				},
				__repositionScrollbars: function() {
					...
					if (o.__indicatorX) {
						o.__indicatorY && (s = 10),
							(r = Math.round(o.__indicatorX.sizeRatio * o.__scrollLeft) || 0),
							(n = o.__scrollLeft - (o.__maxScrollLeft - s)),
							o.__scrollLeft < 0
								? ((t = Math.max(
										o.__indicatorX.minScale,
										(o.__indicatorX.size - Math.abs(o.__scrollLeft)) /
											o.__indicatorX.size
									)),
									(r = 0),
									(o.__indicatorX.indicator.style[o.__transformOriginProperty] =
										"left center"))
								: n > 0
									? ((t = Math.max(
											o.__indicatorX.minScale,
											(o.__indicatorX.size - n) / o.__indicatorX.size
										)),
										(r = o.__indicatorX.maxPos - s),
										(o.__indicatorX.indicator.style[
											o.__transformOriginProperty
										] =
											"right center"))
									: ((r = Math.min(o.__maxScrollLeft, Math.max(0, r))),
										(t = 1));
						var c = "translate3d(" + r + "px, 0, 0) scaleX(" + t + ")";
						o.__indicatorX.transformProp !== c &&
							((o.__indicatorX.indicator.style[o.__transformProperty] = c),
							(o.__indicatorX.transformProp = c));
					}
					if (o.__indicatorY) {
						(a = Math.round(o.__indicatorY.sizeRatio * o.__scrollTop) || 0),
							o.__indicatorX && (l = 10),
							(i = o.__scrollTop - (o.__maxScrollTop - l)),
							o.__scrollTop < 0
								? ((e = Math.max(
										o.__indicatorY.minScale,
										(o.__indicatorY.size - Math.abs(o.__scrollTop)) /
											o.__indicatorY.size
									)),
									(a = 0),
									"center top" !== o.__indicatorY.originProp &&
										((o.__indicatorY.indicator.style[
											o.__transformOriginProperty
										] =
											"center top"),
										(o.__indicatorY.originProp = "center top")))
								: i > 0
									? ((e = Math.max(
											o.__indicatorY.minScale,
											(o.__indicatorY.size - i) / o.__indicatorY.size
										)),
										(a = o.__indicatorY.maxPos - l),
										"center bottom" !== o.__indicatorY.originProp &&
											((o.__indicatorY.indicator.style[
												o.__transformOriginProperty
											] =
												"center bottom"),
											(o.__indicatorY.originProp = "center bottom")))
									: ((a = Math.min(o.__maxScrollTop, Math.max(0, a))), (e = 1));
						var d = "translate3d(0," + a + "px, 0) scaleY(" + e + ")";
						o.__indicatorY.transformProp !== d &&
							((o.__indicatorY.indicator.style[o.__transformProperty] = d),
							(o.__indicatorY.transformProp = d));
					}
				},
				__fadeScrollbars: function(e, t) {
					...
					if (n.options.scrollbarsFade) {
						...
						n.options.scrollbarsFade === !0 &&
							(clearTimeout(n.__scrollbarFadeTimeout),
							"in" == e
								? (n.__indicatorX &&
										n.__indicatorX.indicator.classList.remove(i),
									n.__indicatorY &&
										n.__indicatorY.indicator.classList.remove(i))
								: (n.__scrollbarFadeTimeout = setTimeout(function() {
										n.__indicatorX && n.__indicatorX.indicator.classList.add(i),
											n.__indicatorY &&
												n.__indicatorY.indicator.classList.add(i);
				...
				resize: function(e) {
					...
					t.__container &&
						t.options &&
						t.setDimensions(
							t.__container.clientWidth,
							t.__container.clientHeight,
							t.options.getContentWidth(),
							t.options.getContentHeight(),
							e
						);
				},
				getRenderFn: function() {
					...
					"MozAppearance" in i
						? (e = "gecko")
						: "WebkitAppearance" in i
							? (e = "webkit")
							: "string" == typeof navigator.cpuClass && (e = "trident");
					var r,
						a = { trident: "ms", gecko: "Moz", webkit: "Webkit", presto: "O" }[
							e
						],
						...
						c = a + "TransformOrigin";
					return (
						(t.__perspectiveProperty = l),
						(t.__transformProperty = l),
						(t.__transformOriginProperty = c),
						o.style[s] !== r
							? function(e, i, r, a) {
									var o =
										"translate3d(" + -e + "px," + -i + "px,0) scale(" + r + ")";
									o !== t.contentTransform &&
										((n.style[l] = o), (t.contentTransform = o)),
				...
				setDimensions: function(e, t, n, i, r) {
					...
					(e || t || n || i) &&
						...
						n === +n && (a.__contentWidth = n),
						i === +i && (a.__contentHeight = i),
						a.__computeScrollMax(),
						a.__resizeScrollbars(),
						r || a.scrollTo(a.__scrollLeft, a.__scrollTop, !0, null, !0));
				},
				...
				finishPullToRefresh: function() {
					var e = this,
						t = new Date(),
						n = 0;
					e.refreshStartTime + e.__minSpinTime > t.getTime() &&
						(n = e.refreshStartTime + e.__minSpinTime - t.getTime()),
						setTimeout(function() {
				...
				zoomTo: function(e, t, n, i) {
					...
					r.__isDecelerating &&
						(me.effect.Animate.stop(r.__isDecelerating),
					...
					o > r.__maxScrollLeft ? (o = r.__maxScrollLeft) : 0 > o && (o = 0),
				...
				scrollTo: function(e, t, n, i, r) {
					...
					if (
						(a.__isDecelerating &&
							(me.effect.Animate.stop(a.__isDecelerating),
							(a.__isDecelerating = !1)),
						null != i && i !== a.__zoomLevel)
					) {
						if (!a.options.zooming) throw new Error("Zooming is not enabled!");
						(e *= i), (t *= i), a.__computeScrollMax(i);
					} else i = a.__zoomLevel;
					a.options.scrollingX
						? a.options.paging
							? (e = Math.round(e / a.__clientWidth) * a.__clientWidth)
							: a.options.snapping &&
								(e = Math.round(e / a.__snapWidth) * a.__snapWidth)
						: (e = a.__scrollLeft),
						a.options.scrollingY
							? a.options.paging
								? (t = Math.round(t / a.__clientHeight) * a.__clientHeight)
								: a.options.snapping &&
									(t = Math.round(t / a.__snapHeight) * a.__snapHeight)
							: (t = a.__scrollTop),
						(e = Math.max(Math.min(a.__maxScrollLeft, e), 0)),
						(t = Math.max(Math.min(a.__maxScrollTop, t), 0)),
						e === a.__scrollLeft && t === a.__scrollTop && (n = !1),
						a.__publish(e, t, i, n, r);
				},
				...
				doTouchStart: function(e, t) {
					...
					(n.__decStopped = !(!n.__isDecelerating && !n.__isAnimating)),
						...
						n.__isDecelerating &&
							(me.effect.Animate.stop(n.__isDecelerating),
							(n.__isDecelerating = !1),
							(n.__interruptedAnimation = !0)),
						n.__isAnimating &&
							(me.effect.Animate.stop(n.__isAnimating),
							(n.__isAnimating = !1),
							(n.__interruptedAnimation = !0));
					var i,
						r,
						a = 1 === e.length;
					a
						? ((i = e[0].pageX), (r = e[0].pageY))
						: ((i = Math.abs(e[0].pageX + e[1].pageX) / 2),
						...
						(n.__lastTouchMove = t),
						(n.__lastScale = 1),
						(n.__enableScrollX = !a && n.options.scrollingX),
						(n.__enableScrollY = !a && n.options.scrollingY),
						(n.__isTracking = !0),
				...
				doTouchMove: function(e, t, n) {
					...
					if (i.__isTracking) {
						var r, a;
						2 === e.length
							? ((r = Math.abs(e[0].pageX + e[1].pageX) / 2),
								(a = Math.abs(e[0].pageY + e[1].pageY) / 2),
								!n &&
									i.options.zooming &&
									(n = i.__getScale(i.__initialTouches, e)))
						...
						if (i.__isDragging) {
							...
							if (i.__enableScrollX) {
								...
								(c > m || 0 > c) &&
									(i.options.bouncing
										? (c += s / 2 * i.options.speedMultiplier)
										: (c = c > m ? m : 0));
							}
							if (i.__enableScrollY) {
								...
								d > g || 0 > d
									? i.options.bouncing || (i.__refreshHeight && 0 > d)
										? ((d += l / 2 * i.options.speedMultiplier),
											i.__enableScrollX ||
												null == i.__refreshHeight ||
												(0 > d
													? ((i.__refreshHidden = !1), i.__refreshShow())
													: (i.__refreshHide(), (i.__refreshHidden = !0)),
												!i.__refreshActive && d <= -i.__refreshHeight
													? ((i.__refreshActive = !0),
														i.__refreshActivate && i.__refreshActivate())
													: i.__refreshActive &&
														d > -i.__refreshHeight &&
														((i.__refreshActive = !1),
							...
							(i.__enableScrollX = i.options.scrollingX && w >= v),
								(i.__enableScrollY = i.options.scrollingY && T >= v),
								o.push(i.__scrollLeft, i.__scrollTop, t),
								(i.__isDragging =
									(i.__enableScrollX || i.__enableScrollY) &&
									(w >= _ || T >= _)),
								i.__isDragging &&
									((i.__interruptedAnimation = !1), i.__fadeScrollbars("in"));
						}
						(i.__lastTouchLeft = r),
							(i.__lastTouchTop = a),
							(i.__lastTouchMove = t),
					...
					if (i.__isTracking) {
						if (((i.__isTracking = !1), i.__isDragging))
							if (
								...
								i.__isSingleTouch &&
									i.options.animating &&
									n - i.__lastTouchMove <= 100)
							) {
								for (
									var r = i.__positions, a = r.length - 1, o = a, s = a;
									s > 0 && r[s] > i.__lastTouchMove - 100;
									s -= 3
								)
									o = s;
								if (o !== a) {
									...
									var u =
										i.options.paging || i.options.snapping
											? i.options.decelVelocityThresholdPaging
											: i.options.decelVelocityThreshold;
									(Math.abs(i.__decelerationVelocityX) > u ||
										Math.abs(i.__decelerationVelocityY) > u) &&
										(i.__refreshActive || i.__startDeceleration(n));
								} else i.__scrollingComplete();
							} else n - i.__lastTouchMove > 100 && i.__scrollingComplete();
						else
							i.__decStopped && ((t.isTapHandled = !0), (i.__decStopped = !1));
				...
				__publish: function(e, t, r, a, o) {
					var s = this,
						l = s.__isAnimating;
					if (
						(l && (me.effect.Animate.stop(l), (s.__isAnimating = !1)),
						a && s.options.animating)
					) {
						(s.__scheduledLeft = e),
							(s.__scheduledTop = t),
							(s.__scheduledZoom = r);
						...
						s.__isAnimating = me.effect.Animate.start(
							m,
							g,
							v,
							s.options.animationDuration,
							l ? n : i
						);
					} else
						(s.__scheduledLeft = s.__scrollLeft = e),
							...
							s.__callback && s.__callback(e, t, r, o),
							s.options.zooming && s.__computeScrollMax();
				},
				__computeScrollMax: function(e) {
					var t = this;
					null == e && (e = t.__zoomLevel),
						(t.__maxScrollLeft = Math.max(
							t.__contentWidth * e - t.__clientWidth,
							0
						)),
						(t.__maxScrollTop = Math.max(
							t.__contentHeight * e - t.__clientHeight,
							0
						)),
						t.__didWaitForSize ||
							t.__maxScrollLeft ||
							t.__maxScrollTop ||
							((t.__didWaitForSize = !0), t.__waitForSize());
				},
				...
				__startDeceleration: function() {
					...
					if (e.options.paging) {
						...
						(e.__minDecelerationScrollLeft = 0),
							...
							e.__refreshActive &&
								(e.__minDecelerationScrollTop = -1 * e.__refreshHeight);
					var a = function(t, n, i) {
						e.__stepThroughDeceleration(i);
					};
					e.__minVelocityToKeepDecelerating = e.options.snapping ? 4 : 0.1;
					var o = function() {
							var t =
								Math.abs(e.__decelerationVelocityX) >=
									e.__minVelocityToKeepDecelerating ||
								Math.abs(e.__decelerationVelocityY) >=
									e.__minVelocityToKeepDecelerating;
							return (
								t ||
									((e.__didDecelerationComplete = !0),
									e.options.bouncing &&
										!e.__refreshActive &&
										e.scrollTo(
											Math.min(Math.max(e.__scrollLeft, 0), e.__maxScrollLeft),
											Math.min(Math.max(e.__scrollTop, 0), e.__maxScrollTop),
											e.__refreshActive
										)),
								t
							);
				...
				__stepThroughDeceleration: function(e) {
					...
					if (!t.options.bouncing) {
						var r = Math.max(
							Math.min(t.__maxDecelerationScrollLeft, n),
							t.__minDecelerationScrollLeft
						);
						r !== n && ((n = r), (t.__decelerationVelocityX = 0));
						var a = Math.max(
							Math.min(t.__maxDecelerationScrollTop, i),
					...
					if (
						(e
							? t.__publish(n, i, t.__zoomLevel)
							: ((t.__scrollLeft = n), (t.__scrollTop = i)),
						!t.options.paging)
					) {
					...
					if (t.options.bouncing) {
						...
						if (
							(n < t.__minDecelerationScrollLeft
								? (s = t.__minDecelerationScrollLeft - n)
								: n > t.__maxDecelerationScrollLeft &&
									(s = t.__maxDecelerationScrollLeft - n),
							i < t.__minDecelerationScrollTop
								? (l = t.__minDecelerationScrollTop - i)
								: i > t.__maxDecelerationScrollTop &&
									(l = t.__maxDecelerationScrollTop - i),
							0 !== s)
						) {
							var u =
								s * t.__decelerationVelocityX <= t.__minDecelerationScrollLeft;
							u && (t.__decelerationVelocityX += s * c);
							var p =
								Math.abs(t.__decelerationVelocityX) <=
								t.__minVelocityToKeepDecelerating;
							(!u || p) && (t.__decelerationVelocityX = s * d);
						}
						if (0 !== l) {
							var h =
								l * t.__decelerationVelocityY <= t.__minDecelerationScrollTop;
							h && (t.__decelerationVelocityY += l * c);
							var f =
								Math.abs(t.__decelerationVelocityY) <=
								t.__minVelocityToKeepDecelerating;
				...
				__getScale: function(e, t) {
					return e.length >= 2 && t.length >= 2
						? this.__getDistance(t[0], t[1]) / this.__getDistance(e[0], e[1])
						: 1;
				}
			})),
		...
		(function(e) {
			...
			e.views.ScrollNative = e.views.View.inherit({
				initialize: function(t) {
					var n = this;
					(n.__container = n.el = t.el),
						(n.__content = t.el.firstElementChild),
						(n.__frozen = !1),
						(n.isNative = !0),
						(n.__scrollTop = n.el.scrollTop),
						(n.__scrollLeft = n.el.scrollLeft),
						(n.__clientHeight = n.__content.clientHeight),
						(n.__clientWidth = n.__content.clientWidth),
						(n.__maxScrollTop = Math.max(
							n.__contentHeight - n.__clientHeight,
							0
						)),
						(n.__maxScrollLeft = Math.max(
							n.__contentWidth - n.__clientWidth,
							0
						)),
						(t.startY >= 0 || t.startX >= 0) &&
							e.requestAnimationFrame(function() {
								(n.__originalContainerHeight = n.el.getBoundingClientRect().height),
									(n.el.scrollTop = t.startY || 0),
									(n.el.scrollLeft = t.startX || 0),
									(n.__scrollTop = n.el.scrollTop),
									(n.__scrollLeft = n.el.scrollLeft);
							}),
						(n.options = {
							...
							getContentWidth: function() {
								return Math.max(
									n.__content.scrollWidth,
									n.__content.offsetWidth
								);
							},
							getContentHeight: function() {
								return Math.max(
									n.__content.scrollHeight,
									n.__content.offsetHeight + 2 * n.__content.offsetTop
								);
							}
						});
					...
					(n.onScroll = function() {
						e.scroll.isScrolling || (e.scroll.isScrolling = !0),
							clearTimeout(n.scrollTimer),
							(n.scrollTimer = setTimeout(function() {
				...
				getValues: function() {
					var e = this;
					return (
						e.update(), { left: e.__scrollLeft, top: e.__scrollTop, zoom: 1 }
					);
				},
				update: function() {
					var e = this;
					...
					function r(t, n) {
						...
						function r() {
							var p = Date.now(),
								h = Math.min(1, (p - l) / c),
								f = i(h);
							d != t && (a.el.scrollTop = parseInt(f * (t - d) + d, 10)),
								u != n && (a.el.scrollLeft = parseInt(f * (n - u) + u, 10)),
								1 > h
									? e.requestAnimationFrame(r)
									: (e.tap.removeClonedInputs(a.__container, a),
										(a.el.style.overflowX = o),
										(a.el.style.overflowY = s),
										a.resize());
						}
						var l = Date.now(),
							c = 250,
						...
						return d === t && u === n
							? ((a.el.style.overflowX = o),
								(a.el.style.overflowY = s),
								void a.resize())
							: void e.requestAnimationFrame(r);
					}
					var a = this;
					if (!i)
						return (a.el.scrollTop = n), (a.el.scrollLeft = t), void a.resize();
					var o = a.el.style.overflowX,
						s = a.el.style.overflowY;
					clearTimeout(a.__scrollToCleanupTimeout),
						(a.__scrollToCleanupTimeout = setTimeout(function() {
							(a.el.style.overflowX = o), (a.el.style.overflowY = s);
						}, 500)),
						(a.el.style.overflowY = "hidden"),
				...
				__computeScrollMax: function() {
					...
					(e.__maxScrollLeft = Math.max(e.__contentWidth - e.__clientWidth, 0)),
						(e.__maxScrollTop = Math.max(
							e.__contentHeight - e.__clientHeight,
							0
						)),
						e.__didWaitForSize ||
							e.__maxScrollLeft ||
							e.__maxScrollTop ||
							((e.__didWaitForSize = !0), e.__waitForSize());
				},
				__initEventHandlers: function() {
					var t,
						n,
					...
					(i.scrollChildIntoView = function(a) {
						...
						i.__originalContainerHeight ||
							(i.__originalContainerHeight = o.height),
							(t = i.__originalContainerHeight);
						...
						(!s || u) &&
							(!c &&
								(e.Platform.isIOS() || e.Platform.isFullScreen || d) &&
								e.requestAnimationFrame(function() {
									(t = Math.max(
										0,
										Math.min(
											i.__originalContainerHeight,
											i.__originalContainerHeight -
												(a.detail.keyboardHeight - 43)
										)
									)),
										(r.style.height = t + "px"),
										r.classList.add("keyboard-up"),
										i.resize();
								}),
							(i.isShrunkForKeyboard = !0)),
							(n = a.detail.keyboardHeight),
							a.detail.isElementUnderKeyboard &&
								e.requestAnimationFrame(function() {
									var t = e.DomUtil.getOffsetTop(a.detail.target);
									setTimeout(function() {
										e.Platform.isIOS() && e.tap.cloneFocusedInput(r, i),
											i.scrollTo(0, t - (o.top + 100), !0),
											i.onScroll();
									}, 32);
								}),
							a.stopPropagation();
						...
						(i.resetScrollView = function() {
							i.isShrunkForKeyboard &&
								((i.isShrunkForKeyboard = !1),
								(r.style.height = ""),
								(i.__originalContainerHeight = r.getBoundingClientRect().height),
								e.Platform.isIOS() &&
									e.requestAnimationFrame(function() {
						...
						(i.handleTouchMove = function(e) {
							return i.__frozenShut
								? (e.preventDefault(), e.stopPropagation(), !1)
								: i.__frozen ? (e.preventDefault(), !1) : !0;
						}),
						r.addEventListener("scroll", i.onScroll),
						r.addEventListener("scrollChildIntoView", i.scrollChildIntoView),
						r.addEventListener(e.EVENTS.touchstart, i.handleTouchMove),
						r.addEventListener(e.EVENTS.touchmove, i.handleTouchMove),
						document.addEventListener("resetScrollView", i.resetScrollView);
				},
				__cleanup: function() {
					var n = this,
					...
					i.removeEventListener("scroll", n.onScroll),
						i.removeEventListener("scrollChildIntoView", n.scrollChildIntoView),
						i.removeEventListener(e.EVENTS.touchstart, n.handleTouchMove),
						i.removeEventListener(e.EVENTS.touchmove, n.handleTouchMove),
						document.removeEventListener("resetScrollView", n.resetScrollView),
						e.tap.removeClonedInputs(i, n),
						delete n.__container,
						delete n.__content,
		...
		(function(e) {
			...
			(c.prototype = new l()),
				(c.prototype.start = function(a) {
					var o, s, l, c;
					this.canSwipe() &&
						((o = a.target.classList.contains(n)
							? a.target
							: a.target.classList.contains(t)
								? a.target.querySelector("." + n)
								: e.DomUtil.getParentWithClass(a.target, n)),
						o &&
							(o.classList.remove(i),
							(l =
								parseFloat(
									o.style[e.CSS.TRANSFORM]
										.replace("translate3d(", "")
										.split(",")[0]
								) || 0),
							(s = o.parentNode.querySelector("." + r)),
							s &&
				...
				(c.prototype.isSameItem = function(e) {
					return e._lastDrag && this._currentDrag
						? this._currentDrag.content == e._lastDrag.content
						: !1;
				}),
				(c.prototype.clean = function(t) {
					...
					i &&
						...
						t
							? ((i.content.style[e.CSS.TRANSITION] = "none"),
								n(),
								e.requestAnimationFrame(function() {
									i.content.style[e.CSS.TRANSITION] = "";
								}))
				...
				(c.prototype.drag = e.animationFrameThrottle(function(t) {
					...
					if (
						this._currentDrag &&
						(!this._isDragging &&
							(Math.abs(t.gesture.deltaX) > this.dragThresholdX ||
						...
						var i = Math.min(
							0,
							this._currentDrag.startOffsetX + t.gesture.deltaX
						);
						-n > i && (i = Math.min(-n, -n + 0.4 * (t.gesture.deltaX + n))),
							(this._currentDrag.content.$$ionicOptionsOpen = 0 !== i),
							(this._currentDrag.content.style[e.CSS.TRANSFORM] =
				...
				(c.prototype.end = function(t, n) {
					...
					t.gesture.deltaX > -(i._currentDrag.buttonsWidth / 2) &&
						("left" == t.gesture.direction &&
						Math.abs(t.gesture.velocityX) < 0.3
							? (r = 0)
							: "right" == t.gesture.direction && (r = 0)),
						e.requestAnimationFrame(function() {
							if (0 === r) {
			...
			var d = function(e) {
				var t = this;
				if (
					((t.dragThresholdY = e.dragThresholdY || 0),
					...
					var n = t.listEl;
					do (t.listElTrueTop += n.offsetTop), (n = n.offsetParent);
					while (n);
				}
			};
			(d.prototype = new l()),
				(d.prototype._moveElement = function(t) {
					var n =
						t.gesture.center.pageY +
					...
					if (this._currentDrag) {
						...
						if (this.scrollView) {
							...
							var s = o.offsetTop,
								...
								c =
									r + this._currentDrag.elementHeight / 2 - s - o.offsetHeight;
							t.gesture.deltaY < 0 &&
								l > 0 &&
								i > 0 &&
								(this.scrollView.scrollBy(null, -l),
								e.requestAnimationFrame(function() {
									n.drag(t);
								})),
								t.gesture.deltaY > 0 &&
									c > 0 &&
									i < this.scrollView.getScrollMax().top &&
									(this.scrollView.scrollBy(null, c),
									e.requestAnimationFrame(function() {
										n.drag(t);
									}));
						}
						!this._isDragging &&
							Math.abs(t.gesture.deltaY) > this.dragThresholdY &&
							(this._isDragging = !0),
							this._isDragging &&
								(this._moveElement(t),
								(this._currentDrag.currentY = i + r - a));
					}
				})),
					...
					for (
						var e,
							...
							n = Array.prototype.slice
								.call(t._currentDrag.placeholder.parentNode.children)
								.filter(function(e) {
									return e.nodeName === t.el.nodeName && e !== t.el;
								}),
							i = t._currentDrag.currentY,
							r = 0,
							a = n.length;
						a > r;
						r++
				...
				(d.prototype.end = function(t, n) {
					...
					this.el.classList.remove(o),
						...
						this.onReorder &&
							this.onReorder(this.el, this._currentDrag.startIndex, r),
						(this._currentDrag = { placeholder: null, content: null }),
				...
				(e.views.ListView = e.views.View.inherit({
					initialize: function(t) {
						...
						(t = e.extend(
							...
							!n.itemHeight &&
								...
								(n.itemHeight =
									n.listEl.children[0] &&
									parseInt(n.listEl.children[0].style.height, 10)),
						...
						var i = {};
						e.DomUtil.getParentOrSelfWithClass(n.el, "overflow-scroll") &&
							(i.prevent_default_directions = ["left", "right"]),
					...
					didScroll: function(e) {
						...
						if (t.isVirtual) {
							var n = t.itemHeight,
								...
								o = Math.min(
									i,
									Math.abs(e.scrollTop) + r + t.virtualAddThreshold
								),
								s = parseInt(Math.abs(a / n), 10),
								l = parseInt(Math.abs(o / n), 10);
							(t._virtualItemsToRemove = Array.prototype.slice.call(
								t.listEl.children,
								0,
								s
							)),
								t.renderViewport && t.renderViewport(a, o, s, l);
						}
					},
					...
					clearDragEffects: function(e) {
						this._lastDragOp &&
							(this._lastDragOp.clean && this._lastDragOp.clean(e),
							this._lastDragOp.deregister && this._lastDragOp.deregister(),
							(this._lastDragOp = null));
					},
					_initDrag: function() {
						this._lastDragOp &&
							this._lastDragOp.deregister &&
							this._lastDragOp.deregister(),
					...
					_startDrag: function(t) {
						...
						var i,
							r = n._lastDragOp;
						n._didDragUpOrDown && r instanceof c && r.clean && r.clean(),
							!e.DomUtil.getParentOrSelfWithClass(t.target, s) ||
							("up" != t.gesture.direction && "down" != t.gesture.direction)
								? !n._didDragUpOrDown &&
									("left" == t.gesture.direction ||
										"right" == t.gesture.direction) &&
									Math.abs(t.gesture.deltaX) > 5 &&
									((i = n._getItem(t.target)),
									i &&
										i.querySelector(".item-options") &&
										((n._dragOp = new c({
											el: n.el,
											item: i,
											canSwipe: n.canSwipe
										...
										n._dragOp.start(t),
										t.preventDefault(),
										(n.isScrollFreeze = n.scrollView.freeze(!0))))
								: ((i = n._getItem(t.target)),
									i &&
										((n._dragOp = new d({
											listEl: n.el,
					...
					_handleDrag: function(e) {
						...
						Math.abs(e.gesture.deltaY) > 5 && (t._didDragUpOrDown = !0),
							...
							t._dragOp &&
								(e.gesture.srcEvent.preventDefault(), t._dragOp.drag(e));
					}
				}));
		})(ionic),
		(function(e) {
		...
		(function(e) {
			...
			(e.views.SideMenu = e.views.View.inherit({
				initialize: function(e) {
					(this.el = e.el),
						(this.isEnabled =
							"undefined" == typeof e.isEnabled ? !0 : e.isEnabled),
				...
				initialize: function(e) {
					function t() {
						if (b.offsetWidth) {
							(S = D.children),
								(x = S.length),
								S.length < 2 && (e.continuous = !1),
								T.transitions &&
									e.continuous &&
									S.length < 3 &&
									(D.appendChild(S[0].cloneNode(!0)),
									D.appendChild(D.children[1].cloneNode(!0)),
									(S = D.children)),
								(y = new Array(S.length)),
								(E = b.offsetWidth || b.getBoundingClientRect().width),
								(D.style.width = S.length * E + "px");
							...
							e.continuous &&
								T.transitions &&
								(o(r(M - 1), -E, 0), o(r(M + 1), E, 0)),
								T.transitions || (D.style.left = M * -E + "px"),
						...
						var r = +new Date(),
							a = setInterval(function() {
								...
								return o > i
									? ((D.style.left = n + "px"),
										I && c(),
										e.transitionEnd && e.transitionEnd.call(event, M, S[M]),
										void clearInterval(a))
									: void (D.style.left =
											(n - t) * (Math.floor(o / i * 100) / 100) + t + "px");
							}, 4);
					}
					function c() {
						L = setTimeout(i, I);
					...
					var u,
						...
						f = this;
					window.navigator.pointerEnabled
						? ((u = "pointerdown"), (p = "pointermove"), (h = "pointerup"))
						: window.navigator.msPointerEnabled
							? ((u = "MSPointerDown"),
								(p = "MSPointerMove"),
								(h = "MSPointerUp"))
							: ((u = "touchstart"), (p = "touchmove"), (h = "touchend"));
					var m = "mousedown",
						g = "mousemove",
						v = "mouseup",
						_ = function() {},
					...
					if (b) {
							...
							z = {
								handleEvent: function(n) {
									switch ((!n.touches &&
										n.pageX &&
										n.pageY &&
										(n.touches = [{ pageX: n.pageX, pageY: n.pageY }]),
									n.type)) {
										case u:
											this.start(n);
											break;
								...
								start: function(e) {
									if (e.touches) {
										var t = e.touches[0];
										(k = { x: t.pageX, y: t.pageY, time: +new Date() }),
											(P = void 0),
											(N = {}),
											D.addEventListener(p, this, !1),
											D.addEventListener(g, this, !1),
											D.addEventListener(h, this, !1),
											D.addEventListener(v, this, !1),
											document.addEventListener(h, this, !1),
											document.addEventListener(v, this, !1);
									}
								},
								touchmove: function(t) {
									if (
										...
										var n = t.touches[0];
										(N = { x: n.pageX - k.x, y: n.pageY - k.y }),
											"undefined" == typeof P &&
												(P = !!(P || Math.abs(N.x) < Math.abs(N.y))),
											P ||
												(t.preventDefault(),
												d(),
												e.continuous
													? (s(r(M - 1), N.x + y[r(M - 1)], 0),
														s(M, N.x + y[M], 0),
														s(r(M + 1), N.x + y[r(M + 1)], 0))
													: (e.bouncing
															? (N.x =
																	...
																	(M == S.length - 1 && N.x < 0)
																		...
																		: 1))
															: (E * M - N.x < 0 &&
																	(N.x = Math.min(N.x, E * M)),
																Math.abs(N.x) > E * (S.length - M - 1) &&
																	(N.x = Math.max(
																		-E * (S.length - M - 1),
																		N.x
																	))),
										...
										(n && !i
											? (a
													...
													: (e.continuous
														...
														o(r(M - 1), y[r(M - 1)] + E, C),
														(M = r(M - 1))),
												e.callback && e.callback(M, S[M]))
											: e.continuous
												? (o(r(M - 1), -E, C), o(M, 0, C), o(r(M + 1), E, C))
												: (o(M - 1, -E, C), o(M, 0, C), o(M + 1, E, C))),
										D.removeEventListener(p, z, !1),
										D.removeEventListener(g, z, !1),
										D.removeEventListener(h, z, !1),
										D.removeEventListener(v, z, !1),
										document.removeEventListener(h, z, !1),
										document.removeEventListener(v, z, !1),
										e.onDragEnd && e.onDragEnd();
								},
								transitionEnd: function(t) {
									parseInt(t.target.getAttribute("data-index"), 10) == M &&
										(I && c(),
										e.transitionEnd && e.transitionEnd.call(t, M, S[M]));
								}
							};
						(this.update = function() {
							...
							(this.enableSlide = function(e) {
								return (
									arguments.length && (this.slideIsDisabled = !e),
							...
							(this.kill = function() {
								d(),
									...
									S && (S = []),
									T.addEventListener
										? (D.removeEventListener(u, z, !1),
											D.removeEventListener(m, z, !1),
											D.removeEventListener("webkitTransitionEnd", z, !1),
											D.removeEventListener("msTransitionEnd", z, !1),
											D.removeEventListener("oTransitionEnd", z, !1),
											D.removeEventListener("otransitionend", z, !1),
											D.removeEventListener("transitionend", z, !1),
							...
							(this.load = function() {
								t(),
									I && c(),
									T.addEventListener
										? (D.addEventListener(u, z, !1),
											D.addEventListener(m, z, !1),
											T.transitions &&
												(D.addEventListener("webkitTransitionEnd", z, !1),
												D.addEventListener("msTransitionEnd", z, !1),
												D.addEventListener("oTransitionEnd", z, !1),
												D.addEventListener("otransitionend", z, !1),
												D.addEventListener("transitionend", z, !1)),
				...
				n = function(e, r, a, o) {
					...
					function c() {
						y.autoplayTimeoutId = setTimeout(function() {
							y.params.loop
								? (y.fixLoop(), y._slideNext())
								: y.isEnd
									? r.autoplayStopOnLast ? y.stopAutoplay() : y._slideTo(0)
									: y._slideNext();
						}, y.params.autoplay);
					}
					function d(e, n) {
					...
					function u(e, t) {
						...
						i.observe(e, {
							attributes:
								"undefined" == typeof t.attributes ? !0 : t.attributes,
							...
							s()
								? ((37 === t || 39 === t) &&
										(e.preventDefault
											? e.preventDefault()
											: (e.returnValue = !1)),
									((39 === t && !y.rtl) || (37 === t && y.rtl)) &&
										y.slideNext(),
									((37 === t && !y.rtl) || (39 === t && y.rtl)) &&
										y.slidePrev())
								: ((38 === t || 40 === t) &&
										(e.preventDefault
											? e.preventDefault()
					...
					function h(e) {
						...
						if (0 !== n) {
							if ((y.params.mousewheelInvert && (n = -n), y.params.freeMode)) {
								var r =
										y.getWrapperTranslate() +
										n * y.params.mousewheelSensitivity,
									a = y.isBeginning,
									o = y.isEnd;
								if (
								...
								if (
									new window.Date().getTime() - y.mousewheel.lastScrollTime >
									60
								)
									if (0 > n)
					...
					for (var w in r)
						if (
							...
							(r[w].nodeType ||
								r[w] === window ||
								r[w] === document ||
								("undefined" != typeof i && r[w] instanceof i) ||
								("undefined" != typeof jQuery && r[w] instanceof jQuery))
						)
							_[w] = r[w];
						else {
							_[w] = {};
					...
					if (
						...
						(y.container[0].swiper = y),
							...
							y.params.freeMode &&
								y.classNames.push("swiper-container-free-mode"),
							y.support.flexbox ||
							...
							["cube", "coverflow"].indexOf(y.params.effect) >= 0 &&
							...
							"fade" === y.params.effect &&
								((y.params.slidesPerView = 1),
								(y.params.slidesPerColumn = 1),
								(y.params.slidesPerGroup = 1),
								(y.params.watchSlidesProgress = !0),
								(y.params.spaceBetween = 0),
								"undefined" == typeof v && (y.params.virtualTranslate = !0)),
							y.params.grabCursor &&
								y.support.touch &&
								(y.params.grabCursor = !1),
							(y.wrapper = y.container.children("." + y.params.wrapperClass)),
							y.params.pagination &&
								((y.paginationContainer = t(y.params.pagination)),
							...
							y.rtl &&
								(y.wrongRTL = "-webkit-box" === y.wrapper.css("display")),
							y.params.slidesPerColumn > 1 &&
							...
							(y.imagesToLoad = []),
							(y.imagesLoaded = 0),
							(y.loadImage = function(e, t, n, i, r) {
								function a() {
									r && r();
								}
								var o;
							...
							(y.preloadImages = function() {
								...
								for (var t = 0; t < y.imagesToLoad.length; t++)
									y.loadImage(
										y.imagesToLoad[t],
										y.imagesToLoad[t].currentSrc ||
											y.imagesToLoad[t].getAttribute("src"),
										y.imagesToLoad[t].srcset ||
											y.imagesToLoad[t].getAttribute("srcset"),
										!0,
										e
									);
							}),
							...
							(y.pauseAutoplay = function(e) {
								y.autoplayPaused ||
									...
									(y.autoplayPaused = !0),
									0 === e
										? ((y.autoplayPaused = !1), c())
										: y.wrapper.transitionEnd(function() {
												y &&
													((y.autoplayPaused = !1),
													y.autoplaying ? c() : y.stopAutoplay());
											}));
							}),
							...
							(y.updateAutoHeight = function() {
								...
								e &&
									y.wrapper.css(
										"height",
										y.slides.eq(y.activeIndex)[0].offsetHeight + "px"
									);
							}),
							...
							(y.updateSlidesSize = function() {
								...
								"string" == typeof t &&
									t.indexOf("%") >= 0 &&
									(t = parseFloat(t.replace("%", "")) / 100 * y.size),
									(y.virtualSize = -t),
									y.rtl
								...
								for (e = 0; e < y.slides.length; e++) {
									...
									"none" !== p.css("display") &&
										("auto" === y.params.slidesPerView
											? ((o = s() ? p.outerWidth(!0) : p.outerHeight(!0)),
												y.params.roundLengths && (o = l(o)))
											: ((o =
													(y.size - (y.params.slidesPerView - 1) * t) /
										...
										y.params.centeredSlides
											? ((n = n + o / 2 + i / 2 + t),
												...
												r % y.params.slidesPerGroup === 0 && y.snapGrid.push(n),
												y.slidesGrid.push(n))
											: (r % y.params.slidesPerGroup === 0 &&
													y.snapGrid.push(n),
												y.slidesGrid.push(n),
												(n = n + o + t)),
										(y.virtualSize += o + t),
								...
								if (
									...
									y.params.slidesPerColumn > 1 &&
										((y.virtualSize = (o + y.params.spaceBetween) * a),
										(y.virtualSize =
								...
								0 === y.snapGrid.length && (y.snapGrid = [0]),
									0 !== y.params.spaceBetween &&
										(s()
											? y.rtl
												? y.slides.css({ marginLeft: t + "px" })
												: y.slides.css({ marginRight: t + "px" })
											: y.slides.css({ marginBottom: t + "px" })),
									y.params.watchSlidesProgress && y.updateSlidesOffset();
							}),
							(y.updateSlidesOffset = function() {
								for (var e = 0; e < y.slides.length; e++)
									y.slides[e].swiperSlideOffset = s()
									...
									for (var n = 0; n < y.slides.length; n++) {
										var i = y.slides[n],
											r =
												...
												(i.swiperSlideSize + y.params.spaceBetween);
							...
							(y.updateProgress = function(e) {
								...
								0 === t
									...
									: ((y.progress = (e - y.minTranslate()) / t),
										(y.isBeginning = y.progress <= 0),
										(y.isEnd = y.progress >= 1)),
									y.isBeginning && !n && y.emit("onReachBeginning", y),
							...
							(y.updateActiveIndex = function() {
								var e,
									t,
									n,
									i = y.rtl ? y.translate : -y.translate;
								for (t = 0; t < y.slidesGrid.length; t++)
									"undefined" != typeof y.slidesGrid[t + 1]
										? i >= y.slidesGrid[t] &&
											i <
												y.slidesGrid[t + 1] -
													(y.slidesGrid[t + 1] - y.slidesGrid[t]) / 2
											? (e = t)
											: i >= y.slidesGrid[t] &&
												i < y.slidesGrid[t + 1] &&
												(e = t + 1)
										: i >= y.slidesGrid[t] && (e = t);
								(0 > e || "undefined" == typeof e) && (e = 0),
									(n = Math.floor(e / y.params.slidesPerGroup)),
									n >= y.snapGrid.length && (n = y.snapGrid.length - 1),
									e !== y.activeIndex &&
										((y.snapIndex = n),
							...
							(y.updateClasses = function() {
								...
								if (
									...
									y.params.loop
										? ((n =
												Math.ceil(y.activeIndex - y.loopedSlides) /
												y.params.slidesPerGroup),
											n > y.slides.length - 1 - 2 * y.loopedSlides &&
												(n -= y.slides.length - 2 * y.loopedSlides),
											n > y.bullets.length - 1 && (n -= y.bullets.length))
										: (n =
										...
										y.paginationContainer.length > 1
											? y.bullets.each(function() {
													t(this).index() === n &&
														t(this).addClass(y.params.bulletActiveClass);
												})
								...
								y.params.loop ||
									(y.params.prevButton &&
										(y.isBeginning
											? (t(y.params.prevButton).addClass(
													y.params.buttonDisabledClass
												),
												y.params.a11y &&
													y.a11y &&
													y.a11y.disable(t(y.params.prevButton)))
											: (t(y.params.prevButton).removeClass(
													y.params.buttonDisabledClass
												),
												y.params.a11y &&
													y.a11y &&
													y.a11y.enable(t(y.params.prevButton)))),
									y.params.nextButton &&
										(y.isEnd
											? (t(y.params.nextButton).addClass(
													y.params.buttonDisabledClass
												),
												y.params.a11y &&
													y.a11y &&
													y.a11y.disable(t(y.params.nextButton)))
											: (t(y.params.nextButton).removeClass(
													y.params.buttonDisabledClass
												),
												y.params.a11y &&
													y.a11y &&
													y.a11y.enable(t(y.params.nextButton)))));
							}),
								...
								if (
									...
									for (
										...
										e += y.params.paginationBulletRender
											? y.params.paginationBulletRender(n, y.params.bulletClass)
											: "<" +
						...
						window.navigator.pointerEnabled
							...
							(y.touchEvents = {
								...
								move:
									...
									y.support.touch || !y.params.simulateTouch ? "touchend" : E[2]
							}),
							(window.navigator.pointerEnabled ||
								window.navigator.msPointerEnabled) &&
							...
							(y.initEvents = function(e) {
								...
								y.browser.ie
									? (a[i](y.touchEvents.start, y.onTouchStart, !1),
										o[i](y.touchEvents.move, y.onTouchMove, s),
										o[i](y.touchEvents.end, y.onTouchEnd, !1))
									: (y.support.touch &&
											(a[i](y.touchEvents.start, y.onTouchStart, !1),
											a[i](y.touchEvents.move, y.onTouchMove, s),
											a[i](y.touchEvents.end, y.onTouchEnd, !1)),
										!r.simulateTouch ||
											y.device.ios ||
											y.device.android ||
											(a[i]("mousedown", y.onTouchStart, !1),
											document[i]("mousemove", y.onTouchMove, s),
											document[i]("mouseup", y.onTouchEnd, !1))),
									window[i]("resize", y.onResize),
									y.params.nextButton &&
										(t(y.params.nextButton)[n]("click", y.onClickNext),
										y.params.a11y &&
											y.a11y &&
											t(y.params.nextButton)[n]("keydown", y.a11y.onEnterKey)),
									y.params.prevButton &&
										(t(y.params.prevButton)[n]("click", y.onClickPrev),
										y.params.a11y &&
											y.a11y &&
											t(y.params.prevButton)[n]("keydown", y.a11y.onEnterKey)),
									y.params.pagination &&
										y.params.paginationClickable &&
										(t(y.paginationContainer)[n](
											"click",
											"." + y.params.bulletClass,
											y.onClickIndex
										),
									...
									(y.params.preventClicks ||
										y.params.preventClicksPropagation) &&
										a[i]("click", y.preventClicks, !0);
							}),
							...
							(y.updateClickedSlide = function(e) {
								...
								if (!n || !i)
									return (
										(y.clickedSlide = void 0), void (y.clickedIndex = void 0)
									);
								if (
									((y.clickedSlide = n),
									(y.clickedIndex = t(n).index()),
									...
									if (y.params.loop) {
										...
										(a = t(y.clickedSlide).attr("data-swiper-slide-index")),
											y.params.centeredSlides
						...
						if (
							((y.onTouchStart = function(e) {
								if (
									(e.originalEvent && (e = e.originalEvent),
									(V = "touchstart" === e.type),
									V || !("which" in e) || 3 !== e.which)
								) {
									if (y.params.noSwiping && d(e, "." + y.params.noSwipingClass))
										return void (y.allowClick = !0);
									if (!y.params.swipeHandler || d(e, y.params.swipeHandler)) {
										var n = (y.touches.currentX =
												"touchstart" === e.type
													? e.targetTouches[0].pageX
													: e.pageX),
											i = (y.touches.currentY =
												"touchstart" === e.type
										...
										if (
											!(
												...
												n <= y.params.iOSEdgeSwipeThreshold
											)
										) {
											if (
												((x = !0),
							...
							(y.onTouchMove = function(e) {
								if (
									(e.originalEvent && (e = e.originalEvent),
									!((V && "mousemove" === e.type) || e.preventedByNestedSwiper))
								) {
									...
									if (
										...
										return (D = !0), void (y.allowClick = !1);
									if (
										(M && y.emit("onTouchMove", y, e),
										...
										if (
											...
											var n =
												...
												Math.PI;
											L = s()
												? n > y.params.touchAngle
												: 90 - n > y.params.touchAngle;
										}
										if (
											(L && y.emit("onTouchMoveOpposite", y, e),
											"undefined" == typeof R &&
												y.browser.ieTouch &&
											...
											if (R || !y.browser.ieTouch) {
												...
												if (
													...
													if (y.params.threshold > 0) {
														if (!(Math.abs(i) > y.params.threshold || k))
															return void (P = I);
														if (!k)
															return (
																(k = !0),
													...
													(y.params.freeMode || y.params.watchSlidesProgress) &&
														...
														y.params.freeMode &&
															(0 === G.length &&
																G.push({
																	position:
																		y.touches[s() ? "startX" : "startY"],
																	time: C
																}),
															G.push({
																position:
																	y.touches[s() ? "currentX" : "currentY"],
								...
								if (
									...
									if (
										(y.allowClick &&
												...
												(N = setTimeout(function() {
													y &&
														(y.params.paginationHide &&
															y.paginationContainer.length > 0 &&
															!t(e.target).hasClass(y.params.bulletClass) &&
											...
											300 > i &&
												300 > n - A &&
												(N && clearTimeout(N), y.emit("onDoubleTap", y, e))),
										(A = Date.now()),
										setTimeout(function() {
											y && (y.allowClick = !0);
										}, 0),
									...
									if (
										...
										if (y.params.freeModeMomentum) {
											if (G.length > 1) {
												...
												(y.velocity = s / l),
													...
													Math.abs(y.velocity) <
														y.params.freeModeMinimumVelocity &&
														(y.velocity = 0),
													(l > 150 ||
											...
											if (u < y.maxTranslate())
												...
												(u =
													Math.abs(y.snapGrid[m] - u) <
														Math.abs(y.snapGrid[m - 1] - u) ||
													"next" === y.swipeDirection
														? y.snapGrid[m]
														: y.snapGrid[m - 1]),
													y.rtl || (u = -u);
											...
											y.params.freeModeMomentumBounce && h
												? (y.updateProgress(p),
										...
										return void (
											(!y.params.freeModeMomentum ||
												i >= y.params.longSwipesMs) &&
									...
									for (
										v = 0;
										v < y.slidesGrid.length;
										v += y.params.slidesPerGroup
									)
										"undefined" !=
										typeof y.slidesGrid[v + y.params.slidesPerGroup]
											? r >= y.slidesGrid[v] &&
									...
									if (i > y.params.longSwipesMs) {
										...
										"next" === y.swipeDirection &&
											(T >= y.params.longSwipesRatio
												? y.slideTo(_ + y.params.slidesPerGroup)
												: y.slideTo(_)),
											"prev" === y.swipeDirection &&
										...
										"next" === y.swipeDirection &&
											y.slideTo(_ + y.params.slidesPerGroup),
											"prev" === y.swipeDirection && y.slideTo(_);
									}
								}
							}),
							...
							(y.slideTo = function(e, t, n, i) {
								...
								y.params.autoplay &&
									y.autoplaying &&
									(i || !y.params.autoplayDisableOnInteraction
										? y.pauseAutoplay(t)
										: y.stopAutoplay()),
									y.updateProgress(r);
								for (var a = 0; a < y.slidesGrid.length; a++)
									-Math.floor(100 * r) >= Math.floor(100 * y.slidesGrid[a]) &&
										(e = a);
								...
								"undefined" == typeof e && (e = !0),
									...
									e &&
										...
										y.activeIndex !== y.previousIndex &&
											...
											a.$emit("$ionicSlides.slideChangeStart", {
												slider: y,
								...
								(y.animating = !1),
									...
									e &&
										...
										y.activeIndex !== y.previousIndex &&
											...
											a.$emit("$ionicSlides.slideChangeEnd", {
												slider: y,
												activeIndex: y.getSlideDataIndex(y.activeIndex),
												previousIndex: y.getSlideDataIndex(y.previousIndex)
											}),
							...
							(y.setWrapperTransition = function(e, t) {
								y.wrapper.transition(e),
									...
									y.params.parallax &&
										y.parallax &&
										y.parallax.setTransition(e),
									y.params.scrollbar &&
										y.scrollbar &&
										y.scrollbar.setTransition(e),
									y.params.control &&
										y.controller &&
										y.controller.setTransition(e, t),
							...
							(y.setWrapperTranslate = function(e, t, n) {
								var i = 0,
									...
									a = 0;
								s() ? (i = y.rtl ? -e : e) : (r = e),
									y.params.roundLengths && ((i = l(i)), (r = l(r))),
									y.params.virtualTranslate ||
										(y.support.transforms3d
											? y.wrapper.transform(
													"translate3d(" + i + "px, " + r + "px, " + a + "px)"
												)
											: y.wrapper.transform(
													"translate(" + i + "px, " + r + "px)"
												)),
									(y.translate = s() ? i : r);
								var o,
									c = y.maxTranslate() - y.minTranslate();
								(o = 0 === c ? 0 : (e - y.minTranslate()) / c),
									...
									y.params.control &&
										y.controller &&
										y.controller.setTranslate(y.translate, n),
							...
							(y.initObservers = function() {
								if (y.params.observeParents)
									for (var e = y.container.parents(), t = 0; t < e.length; t++)
										u(e[t]);
								u(y.container[0], { childList: !1 }),
									u(y.wrapper[0], { attributes: !1 });
							}),
							...
							(y.updateLoop = function() {
								...
								if (angular.element(e).hasClass(y.params.slideDuplicateClass)) {
									for (
										var t = angular.element(e).attr("data-swiper-slide-index"),
											n = y.wrapper.children("." + y.params.slideClass),
											i = 0;
										i < n.length;
										i++
									)
										if (
											!angular
												.element(n[i])
												.hasClass(y.params.slideDuplicateClass) &&
											angular.element(n[i]).attr("data-swiper-slide-index") ===
												t
										) {
											y.slideTo(i, 0, !1, !0);
											break;
							...
							(y.createLoop = function() {
								...
								"auto" !== y.params.slidesPerView ||
									...
									(y.loopedSlides =
										y.loopedSlides + y.params.loopAdditionalSlides),
								...
								for (
									e.each(function(n, i) {
										var r = t(this);
										n < y.loopedSlides && s.push(i),
											n < e.length &&
												n >= e.length - y.loopedSlides &&
												a.push(i),
									...
									(r = angular
										.element(s[n])
										.clone()
										.addClass(y.params.slideDuplicateClass)),
										r.removeAttr("ng-transclude"),
										r.removeAttr("ng-repeat"),
										(i = angular.element(s[n]).scope()),
										(r = o(r)(i)),
										angular.element(y.wrapper).append(r);
								for (n = a.length - 1; n >= 0; n--)
									(r = angular
										...
										r.removeAttr("ng-transclude"),
										r.removeAttr("ng-repeat"),
										(i = angular.element(a[n]).scope()),
										(r = o(r)(i)),
										angular.element(y.wrapper).prepend(r);
							}),
							...
							(y.removeSlide = function(e) {
								...
								y.params.loop && y.createLoop(),
									(y.params.observer && y.support.observer) || y.update(!0),
									y.params.loop
										? y.slideTo(n + y.loopedSlides, 0, !1)
										: y.slideTo(n, 0, !1);
							}),
											...
											if (
												...
												0 === h.length &&
													...
													0 === f.length &&
														...
														r.append(f));
												r[0].progress;
												h.length && (h[0].style.opacity = -r[0].progress),
											...
											if (
												...
												0 === _.length &&
													...
													0 === w.length &&
														...
														l.append(w)),
													_.length && (_[0].style.opacity = u > 0 ? u : 0),
							...
							(y.lazy = {
								...
								loadImageInSlide: function(e, n) {
									if (
										"undefined" != typeof e &&
										("undefined" == typeof n && (n = !0), 0 !== y.slides.length)
									) {
										var i = y.slides.eq(e),
											r = i.find(
							...
							(y.scrollbar = {
								...
								enableDraggable: function() {
									...
									t(e.track).on(y.touchEvents.start, e.dragStart),
										t(n).on(y.touchEvents.move, e.dragMove),
										t(n).on(y.touchEvents.end, e.dragEnd);
								},
								disableDraggable: function() {
									var e = y.scrollbar,
										n = y.support.touch ? e.track : document;
									t(e.track).off(y.touchEvents.start, e.dragStart),
										t(n).off(y.touchEvents.move, e.dragMove),
										t(n).off(y.touchEvents.end, e.dragEnd);
								},
								set: function() {
									...
									function i(t) {
										(e =
											...
											"slide" === y.params.controlBy &&
												(y.controller.getInterpolateFunction(t),
												(a = -y.controller.spline.interpolate(-e))),
											(a && "container" !== y.params.controlBy) ||
												((r =
													(t.maxTranslate() - t.minTranslate()) /
													(y.maxTranslate() - y.minTranslate())),
												(a = (e - y.minTranslate()) * r + t.minTranslate())),
											y.params.controlInverse && (a = t.maxTranslate() - a),
											t.updateProgress(a),
											t.setWrapperTranslate(a, !1, y),
											t.updateActiveIndex();
									}
									var r,
										a,
						...
						(y.disableMousewheelControl = function() {
							return y.mousewheel.event
								? (y.container.off(y.mousewheel.event, h), !0)
								: !1;
						}),
							(y.enableMousewheelControl = function() {
								return y.mousewheel.event
									? (y.container.on(y.mousewheel.event, h), !0)
									: !1;
							}),
							(y.parallax = {
								setTranslate: function() {
							...
							(y.off = function(e, t) {
								...
								if (
									...
									for (n = 0; n < y.emitterEventListeners[e].length; n++)
										y.emitterEventListeners[e][n] === t &&
											y.emitterEventListeners[e].splice(n, 1);
									return y;
								}
							}),
							(y.once = function(e, t) {
							...
							(y.a11y = {
								...
								init: function() {
									...
									if (y.params.prevButton) {
										...
										y.a11y.makeFocusable(n),
											y.a11y.addRole(n, "button"),
											y.a11y.addLabel(n, y.params.prevSlideMessage);
									}
						...
						return (
							(e.prototype = {
									...
									for (var r = e.split(" "), a = 0; a < r.length; a++)
										for (var o = 0; o < this.length; o++)
											if ("function" == typeof t || t === !1)
												...
												for (
													var s = 0;
													s < this[o].dom7LiveListeners.length;
													s++
												)
								...
								transitionEnd: function(e) {
									function t(a) {
										if (a.target === this)
											for (e.call(this, a), n = 0; n < i.length; n++)
												r.off(i[n], t);
									}
									var n,
										i = [
								...
								width: function() {
									return this[0] === window
										? window.innerWidth
										: this.length > 0 ? parseFloat(this.css("width")) : null;
								},
								...
								height: function() {
									return this[0] === window
										? window.innerHeight
										: this.length > 0 ? parseFloat(this.css("height")) : null;
								},
								...
								find: function(t) {
									for (var n = [], i = 0; i < this.length; i++)
										for (
											var r = this[i].querySelectorAll(t), a = 0;
											a < r.length;
											a++
										)
											n.push(r[a]);
								...
								children: function(n) {
									for (var i = [], r = 0; r < this.length; r++)
										for (var a = this[r].childNodes, o = 0; o < a.length; o++)
											n
												? 1 === a[o].nodeType && t(a[o]).is(n) && i.push(a[o])
												: 1 === a[o].nodeType && i.push(a[o]);
			...
			e.views.Toggle = e.views.View.inherit({
				initialize: function(t) {
					...
					(this.el = t.el),
						...
						(this.dragStartGesture = e.onGesture(
							"dragstart",
							this.dragStartHandler,
							this.el
						)),
						(this.dragGesture = e.onGesture("drag", this.dragHandler, this.el)),
						(this.dragHoldGesture = e.onGesture(
							"hold",
							this.holdHandler,
							this.el
						)),
						(this.dragReleaseGesture = e.onGesture(
							"release",
							this.releaseHandler,
							this.el
						));
				...
				tap: function() {
					"disabled" !== this.el.getAttribute("disabled") &&
					...
					this._dragInfo &&
						...
						e.requestAnimationFrame(function() {
							if (n._dragInfo) {
								...
								n._dragInfo.initialState
									? e < n.triggerThreshold
										? n.setOpenPercent(0)
										: e > n._dragInfo.triggerX && n.setOpenPercent(100)
									: e < n._dragInfo.triggerX
										? n.setOpenPercent(0)
										: e > i && n.setOpenPercent(100);
							}
						}));
				},
				endDrag: function() {
				...
				setOpenPercent: function(t) {
					if (
						...
						if (((this.openPercent = t), 0 === t)) this.val(!1);
							...
							var n = Math.round(
								t / 100 * this.track.offsetWidth - this.handle.offsetWidth
							);
							(n = 1 > n ? 0 : n),
								(this.handle.style[e.CSS.TRANSFORM] =
...
(function(T, P, u) {
				...
				if (!m.get(a)) {
					...
					try {
						y(a)
							...
							: D(a)
								? b.push(p.invoke(a))
								: M(a) ? b.push(p.invoke(a)) : Sa(a, "module");
					} catch (e) {
								...
								return {
									pre: function(a, c, h) {
										...
										k &&
											((h[e] = k(a)),
											((c[e] || (c[e] = [])).$$inter = !0),
											((h.$$observers && h.$$observers[e].$$scope) || a)
												.$watch(k, function(a, b) {
													"class" === e && a != b
														? h.$updateClass(a, b)
														: h.$set(e, a);
												}));
				...
				function n(c, d) {
					...
					K &&
						...
						A(I)
							? I && D(I.then)
								? I.then(n, n)
								: M(I) ? l(I[1], I[0], ia(I[2]), I[3]) : l(I, 200, {}, "OK")
							: K.put(L, C));
					z(I) &&
	...
	function ec(a, b, d) {
		...
		this.$$parse = function(c) {
			var e = la(a, c) || la(b, c),
				f;
			z(e) || "#" !== e.charAt(0)
				? this.$$html5 ? (f = e) : ((f = ""), z(e) && ((a = c), this.replace()))
				: ((f = la(d, e)), z(f) && (f = e));
			id(f, this);
			c = this.$$path;
			var e = a,
				...
				d.$watch(function() {
					...
					if (x || m)
						(x = !1),
							d.$evalAsync(function() {
								var b = l.absUrl(),
									c = d.$broadcast("$locationChangeStart", b, a, l.$$state, f)
										.defaultPrevented;
								l.absUrl() === b &&
									(c
										? (l.$$parse(a), (l.$$state = f))
	...
	function og() {
		return function(a, b, d) {
			...
			return 0 <= b
				? a.slice(d, d + b)
				: 0 === d ? a.slice(b, a.length) : a.slice(Math.max(0, d + b), d);
		};
	}
	function Bd(a) {
		function b(b, d) {
	...
	function nb(a, b, d, c) {
		return function(e, f, g, h, k, l, m) {
			...
			h.$parsers.push(function(a) {
				return h.$isEmpty(a)
					? null
					: b.test(a) ? ((a = d(a, s)), q && (a = Rb(a, q)), a) : u;
			});
		...
		c.$setValidity = function(a, e, f) {
			...
			e =
				c.$pending && c.$pending[a]
					? u
					: c.$error[a] ? !1 : c.$$success[a] ? !0 : null;
			d(a, e);
			...
			function(a, b, d, c, e, f, g, h, k, l) {
				...
				this.$$debounceViewValueCommit = function(b) {
					...
					d &&
						...
						R(d)
							? (c = d)
							: R(d[b]) ? (c = d[b]) : R(d["default"]) && (c = d["default"]));
					g.cancel(y);
					c
						? (y = g(function() {
								r.$commitViewValue();
...
(function(E, w, Va) {
	...
	function T(a, b, c) {
		...
		c.preparationClasses &&
			((d.preparationClasses = W(c.preparationClasses, d.preparationClasses)),
	...
	var O = w.noop,
		...
		X,
		va;
	N(E.ontransitionend) && Y(E.onwebkittransitionend)
		? ((R = "WebkitTransition"), (ua = "webkitTransitionEnd transitionend"))
		: ((R = "transition"), (ua = "transitionend"));
	N(E.onanimationend) && Y(E.onwebkitanimationend)
		? ((X = "WebkitAnimation"), (va = "webkitAnimationEnd animationend"))
		: ((X = "animation"), (va = "animationend"));
	var qa = X + "Delay",
		wa = X + "Duration",
		ma = R + "Delay";
	E = R + "Duration";
					...
					function(b, c, f, u, l, w, s, M, v, h) {
						...
						function y(a, b, c) {
							...
							(a = G[c]) &&
								q(a, function(a) {
									t.call(a.node, g)
										? k.push(a.callback)
										: "leave" === c && t.call(a.node, d) && k.push(a.callback);
								});
							return k;
						}
						function k(a, g, k) {
							...
							function G(b) {
								var c = a,
									g = h;
								g.preparationClasses &&
									(c.removeClass(g.preparationClasses),
									(g.preparationClasses = null));
								g.activeClasses &&
							...
							h.removeClass && !I(h.removeClass) && (h.removeClass = null);
							...
							(Z = l.structural) ||
								(Z =
									("animate" === l.event &&
										0 < Object.keys(l.options.to || {}).length) ||
									e(l));
							...
							c.$$postDigest(function() {
								...
								if (c || b.counter !== M || !d) {
									...
									(g = !b.structural && e(b, !0) ? "setClass" : b.event),
										D(a, 2),
										(b = w(a, g, b.options)),
										b.done(function(b) {
											G(!b);
						...
						function n(a, b, c) {
							...
							for (b = A(b); b; ) {
								...
								if (N(h) || !0 === h)
									(a = H.data(b, "$$ngAnimateChildren")), Y(a) && (h = a);
								if (k && !1 === h) break;
								g || (g = J(b, c));
								if (g && d) break;
								...
								q(c, function(c, h) {
									...
									if (e && f) {
										...
										if (!k[n]) {
											...
											D.classes.length ? b.push(D) : (b.push(m), b.push(C));
										}
								...
								q(c, function(a) {
									d.push({
										...
										fn: function() {
											...
											if (
												b(
													a.anchors ? a.from.element || a.to.element : a.element
												)
											) {
												var g = k(a);
												g && (c = g.start);
		...
		.provider("$animateCss", [
			...
			function(a) {
				...
				this.$get = [
					...
					"$$rAFScheduler",
					"$$animateQueue",
					function(a, e, f, r, x, F, u, l) {
						function w(a, b) {
							var c = a.parentNode;
							return (
								(c.$$ngAnimateParentKey || (c.$$ngAnimateParentKey = ++P)) +
								"-" +
								a.getAttribute("class") +
								"-" +
								b
						...
						function s(k, h, f, l) {
							...
							0 < b.count(f) &&
								...
								n ||
									...
									e.addClass(k, h),
									(n = Da(a, k, l)),
									(n.animationDuration = Math.max(n.animationDuration, 0)),
									(n.transitionDuration = Math.max(n.transitionDuration, 0)),
									e.removeClass(k, h),
									c.put(f, n)));
							return n || {};
						}
						...
						function v(c, h, e) {
							...
							h ||
								((h = Da(a, c, Sa)),
								"infinite" === h.animationIterationCount &&
									(h.animationIterationCount = 1));
							b.put(e, h);
							c = h;
							e = c.animationDelay;
							h = c.transitionDelay;
						...
						return function(a, c) {
								...
								function b() {
									if (!P) {
										...
										p.applyAnimationDelay &&
											(($ =
												"boolean" !== typeof g.delay && sa(g.delay)
													? parseFloat(g.delay)
													: $),
											(I = Math.max($, 0)),
											(B.animationDelay = $),
										...
										g.to &&
											(g.cleanupStyles && Ga(G, m, Object.keys(g.to)),
											Ba(a, g));
									}
								}
								function c() {
							...
							g.transitionStyle &&
								((t = [R, g.transitionStyle]), la(m, t), y.push(t));
							0 <= g.duration &&
								((t = 0 < m.style[R].length),
								(t = Ea(g.duration, t)),
								la(m, t),
								y.push(t));
							g.keyframeStyle &&
								((t = [X, g.keyframeStyle]), la(m, t), y.push(t));
							var ca = U
								? 0 <= g.staggerIndex ? g.staggerIndex : b.count(ia)
								: 0;
							...
							p.hasAnimations = 0 < B.animationDuration;
							p.hasTransitionAll =
								p.hasTransitions && "all" == B.transitionProperty;
							...
							p.applyTransitionDelay =
								sa(g.delay) && (p.applyTransitionDuration || p.hasTransitions);
							...
							if (p.applyTransitionDuration || p.applyAnimationDuration)
								(L = g.duration ? parseFloat(g.duration) : L),
									p.applyTransitionDuration &&
										((p.hasTransitions = !0),
										(B.transitionDuration = L),
										(t = 0 < m.style[R + "Property"].length),
										y.push(Ea(L, t))),
									p.applyAnimationDuration &&
										((p.hasAnimations = !0),
										(B.animationDuration = L),
										y.push([wa, L + "s"]));
							if (0 === L && !p.recalculateTimingStyles) return z();
							if (null != g.delay) {
								var aa;
								"boolean" !== typeof g.delay &&
									((aa = parseFloat(g.delay)), (I = Math.max(aa, 0)));
								p.applyTransitionDelay && y.push([ma, aa + "s"]);
								p.applyAnimationDelay && y.push([qa, aa + "s"]);
							}
							null == g.duration &&
								0 < B.transitionDuration &&
								(p.recalculateTimingStyles = p.recalculateTimingStyles || ja);
							Q = 1e3 * I;
							T = 1e3 * L;
							g.skipBlocking ||
								((p.blockTransition = 0 < B.transitionDuration),
								(p.blockKeyframeAnimation =
									0 < B.animationDuration &&
									0 < U.animationDelay &&
									0 === U.animationDuration));
							g.from &&
								(g.cleanupStyles && Ga(G, m, Object.keys(g.from)), Aa(a, g));
							p.blockTransition || p.blockKeyframeAnimation
								? D(L)
								: g.skipBlocking || pa(m, !1);
							return {
								$$willAnimate: !0,
								end: d,
								start: function() {
									if (!P)
										return (
											(N = { end: d, cancel: u, resume: null, pause: null }),
											(E = new f(N)),
											M(K),
											E
										);
			...
			function(a) {
				...
				this.$get = [
					...
					function(a, c, d, e, f, r, x) {
						...
						c = A(e);
						var v = H(
							(c.parentNode && 11 === c.parentNode.nodeType) || M.contains(c)
								? c
								: M
						);
						Q(r);
						return function(a) {
							return a.from && a.to
								? w(a.from, a.to, a.classes, a.anchors)
								: s(a);
						};
					}
				];
						...
						return function(a, b, d, u) {
							...
							function A(a, b, d, e, g) {
								...
								if (0 === f.length) {
									var h, k;
									"beforeSetClass" === g
										? ((h = s(a, "removeClass", d, e, "beforeRemoveClass")),
											(k = s(a, "addClass", d, e, "beforeAddClass")))
										: "setClass" === g &&
											((h = s(a, "removeClass", d, e, "removeClass")),
											(k = s(a, "addClass", d, e, "addClass")));
									h && (f = f.concat(h));
									k && (f = f.concat(k));
								}
								if (0 !== f.length)
							...
							d ||
								((d = a.attr("class") || ""),
								u.addClass && (d += " " + u.addClass),
								u.removeClass && (d += " " + u.removeClass));
							var h = u.addClass,
								H = u.removeClass,
								y = e(d),
								k,
...
(function(A, e, B) {
	...
	(function(a) {
		...
		var c = (a.documentElement || a.getDocumentElement())
	...
	e.module("ngSanitize").filter("linky", [
		"$sanitize",
		function(a) {
			...
			return function(f, h, m) {
				...
				function q(a, b) {
					...
					if (e.isObject(m)) for (c in m) p.push(c + '="' + m[c] + '" ');
					else m = {};
				...
				(this.Param = function(a, b, d, e) {
					...
					function i(b, c, d) {
						...
						return c
							? c
							: b.type
								? b.type instanceof r ? b.type : new r(b.type)
								: "config" === d ? v.any : v.string;
					}
					function k() {
		...
		function t(a, d) {
			...
			function h(d, e, f, g) {
				function h(a, b, c) {
					return "/" === p
						? a
						: b ? p.slice(0, -1) + a : c ? p.slice(1) + a : a;
				}
				function m(a) {
					function b(a) {
						var b = a(f, d);
			...
			function p(b) {
				...
				var e =
					-1 !== c.indexOf(".")
						...
						: I(b.parent)
							? b.parent
							: J(b.parent) && I(b.parent.name) ? b.parent.name : "";
			...
			function u(a, e, f, h, m, o, p) {
				...
				return (
					...
					(x.is = function(a, b, d) {
						...
						return G(e)
							? x.$current !== e ? !1 : b ? j(e.params.$$values(b), o) : !0
							: c;
					}),
...
!(function() {
		...
		function a(i, a, c, s, u) {
			...
			function h() {
				return (
					...
					(T = new e({
						...
						widthData: V,
						forceRefreshImages: !(
							!l(c.forceRefreshImages) || "false" === c.forceRefreshImages
						),
						keyExpression: I,
						renderBuffer: D,
						scope: i,
			...
			function p() {
				var e = angular.element(
					b.__content.querySelector(".collection-repeat-after-container")
				);
				if (!e.length) {
					var t = !1,
					...
					(e = angular.element(
						...
						b.options.scrollingX && e.addClass("horizontal"),
						e.append(n),
						b.__content.appendChild(e[0]);
				}
				return e;
			}
			function v() {
			...
			function g() {
				...
				if ((e && (A.computed || V.computed) && w(), e && A.computed)) {
					if (((A.value = E.height), !A.value))
						throw new Error(
							'collection-repeat tried to compute the height of repeated elements "' +
								k +
								'", but was unable to. Please provide the "item-height" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/'
						);
				} else !A.dynamic && A.getValue && (A.value = A.getValue());
				if (e && V.computed) {
					if (((V.value = E.width), !V.value))
						throw new Error(
							'collection-repeat tried to compute the width of repeated elements "' +
								k +
								'", but was unable to. Please provide the "item-width" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/'
						);
						...
						(n.dynamic = !0),
							(n.getValue =
								n === A
									? function(e, t) {
											var n = i(e, t);
											return n.charAt && "%" === n.charAt(n.length - 1)
												? Math.floor(parseFloat(n) / 100 * b.__clientHeight)
												: parseInt(n);
										}
									: function(e, t) {
											var n = i(e, t);
											return n.charAt && "%" === n.charAt(n.length - 1)
												? Math.floor(parseFloat(n) / 100 * b.__clientWidth)
												: parseInt(n);
										});
				}
			}
			...
			if (
				...
				b.options.scrollingX && b.options.scrollingY)
			)
				throw new Error(
					"collection-repeat expected a parent x or y scrollView, not an xy scrollView."
				);
			...
			if (!C)
				throw new Error(
					"collection-repeat expected expression in form of '_item_ in _collection_[ track by _id_]' but got '" +
						c.collectionRepeat +
						"'."
				);
			var T,
			...
			r(g, 0, !1),
				i.$watchCollection(x, function(e) {
					if (((P = e || (e = [])), !angular.isArray(e)))
						throw new Error(
	...
	function t(e, t, n) {
		...
		return function(o) {
			...
			function a(t) {
				if (!a.destroyed) {
					...
					ee.updateRenderRange(d, f),
						(F = Math.max(0, F - T)),
						(W = Math.min(A.length - 1, W + T));
					for (n in Z)
						(F > n || n > W) &&
							((r = Z[n]), delete Z[n], G.push(r), (r.isShown = !1));
					for (n = F; W >= n; n++)
						n >= A.length ||
							(Z[n] && !t) ||
							((r =
								Z[n] ||
								(Z[n] = G.length ? G.pop() : j.length ? j.shift() : new s())),
							K.push(r),
							(r.isShown = !0),
							(u = r.scope),
							(u.$index = n),
							...
							(u.$odd = !(u.$even = 0 === (1 & n))),
							u.$$disconnected && ionic.Utils.reconnectScope(r.scope),
							(l = ee.getDimensions(n)),
							(r.secondaryPos !== l.secondaryPos ||
								r.primaryPos !== l.primaryPos) &&
								(r.node.style[ionic.CSS.TRANSFORM] = O.replace(
									N,
									(r.primaryPos = l.primaryPos)
								).replace(z, (r.secondaryPos = l.secondaryPos))),
							(r.secondarySize !== l.secondarySize ||
								r.primarySize !== l.primarySize) &&
								(r.node.style.cssText = r.node.style.cssText.replace(
									m,
									H.replace(N, (r.primarySize = l.primarySize) + 1).replace(
										z,
										(r.secondarySize = l.secondarySize)
									)
								)));
					for (
						W === A.length - 1 &&
						((l = ee.getDimensions(A.length - 1) || i),
						(w.style[ionic.CSS.TRANSFORM] = O.replace(
							N,
							l.primaryPos + l.primarySize
						).replace(z, 0)));
						G.length;
						...
						(r = G.pop()),
							...
							j.push(r),
							(r.node.style[ionic.CSS.TRANSFORM] =
			...
			function s() {
				...
				(this.scope = I.$new()),
					(this.id = "item" + J++),
					x(this.scope, function(t) {
						(e.element = t),
							e.element.data("$$collectionRepeatItem", e),
							(e.node = t[0]),
							(e.node.style[ionic.CSS.TRANSFORM] =
								"translate3d(-9999px,-9999px,0)"),
							(e.node.style.cssText += " height: 0px; width: 0px;"),
							ionic.Utils.disconnectScope(e.scope),
							b.appendChild(e.node),
							(e.images = t[0].getElementsByTagName("img"));
					});
			}
			function l() {
				(this.getItemPrimarySize = P),
					(this.getItemSecondarySize = D),
					(this.getScrollValue = function() {
						return Math.max(
							0,
							Math.min(B.__scrollTop - q, B.__maxScrollTop - q - U)
						);
					}),
					(this.refreshDirection = function() {
						(this.scrollPrimarySize = B.__clientHeight),
							(this.scrollSecondarySize = B.__clientWidth),
							(this.estimatedPrimarySize = v),
							(this.estimatedSecondarySize = $),
							(this.estimatedItemsAcross =
								(R && Math.floor(B.__clientWidth / $)) || 1);
					});
			}
			function u() {
				(this.getItemPrimarySize = D),
					(this.getItemSecondarySize = P),
					(this.getScrollValue = function() {
						return Math.max(
							0,
							Math.min(B.__scrollLeft - q, B.__maxScrollLeft - q - U)
						);
					}),
					(this.refreshDirection = function() {
						(this.scrollPrimarySize = B.__clientWidth),
							(this.scrollSecondarySize = B.__clientHeight),
							(this.estimatedPrimarySize = $),
							(this.estimatedSecondarySize = v),
							(this.estimatedItemsAcross =
								(R && Math.floor(B.__clientHeight / v)) || 1);
					});
			}
			function d() {
				(this.getEstimatedSecondaryPos = function(e) {
					...
					(this.getEstimatedPrimaryPos = function(e) {
						return (
							Math.floor(e / this.estimatedItemsAcross) *
							this.estimatedPrimarySize
						);
					}),
					(this.getEstimatedIndex = function(e) {
						return (
							Math.floor(e / this.estimatedPrimarySize) *
							this.estimatedItemsAcross
						);
					});
			}
			...
			function h() {
				this.getContentSize = function() {
					return (
						this.getEstimatedPrimaryPos(A.length - 1) +
						this.estimatedPrimarySize +
						q +
						U
					);
				...
				(this.getDimensions = function(t) {
					return (
						(e.primaryPos = this.getEstimatedPrimaryPos(t)),
					...
					(this.updateRenderRange = function(e, t) {
						(F = Math.max(0, this.getEstimatedIndex(e))),
							(W = Math.min(
								A.length - 1,
								this.getEstimatedIndex(t) + this.estimatedItemsAcross - 1
							)),
							(Y = Math.max(0, this.getEstimatedPrimaryPos(F))),
							(X = this.getEstimatedPrimaryPos(W) + this.estimatedPrimarySize);
					});
			}
			function p() {
				function e(e) {
					var t, r, a;
					for (t = Math.max(0, n); e >= t && (a = c[t]); t++)
						(r = c[t - 1] || i),
				...
				function t(e) {
					var t, r, a;
					for (t = Math.max(n, 0); e >= t && (a = c[t]); t++)
						(r = c[t - 1] || i),
							(a.secondarySize = Math.min(
								o.getItemSecondarySize(t, A[t]),
								o.scrollSecondarySize
							)),
							(a.secondaryPos = r.secondaryPos + r.secondarySize),
							0 === t ||
							a.secondaryPos + a.secondarySize > o.scrollSecondarySize
								? ((a.secondaryPos = 0),
									(a.primarySize = o.getItemPrimarySize(t, A[t])),
									(a.primaryPos = r.primaryPos + r.rowPrimarySize),
									(a.rowStartIndex = t),
									(a.rowPrimarySize = a.primarySize))
								: ((a.primarySize = o.getItemPrimarySize(t, A[t])),
									(a.primaryPos = r.primaryPos),
									(a.rowStartIndex = r.rowStartIndex),
									(c[
										a.rowStartIndex
									].rowPrimarySize = a.rowPrimarySize = Math.max(
										c[a.rowStartIndex].rowPrimarySize,
										a.primarySize
									)),
									(a.rowPrimarySize = Math.max(
										a.primarySize,
										a.rowPrimarySize
									)));
				}
				...
				(this.getContentSize = function() {
					var e = c[n] || i;
					return (
						(e.primaryPos + e.primarySize || 0) +
						this.getEstimatedPrimaryPos(A.length - n - 1) +
						q +
						U
					);
				}),
				...
				this.updateRenderRange = function(e, t) {
					var n, i, o;
					if (
						(this.getDimensions(2 * this.getEstimatedIndex(t)),
						-1 === s || 0 === e)
					)
						n = 0;
					else if (e >= l)
						for (
							...
							i > n &&
							!(
								(o = this.getDimensions(n)) &&
								o.primaryPos + o.rowPrimarySize >= e
							);
							n++
						);
					else
					...
					(F = Math.min(Math.max(0, n), A.length - 1)),
						(Y = -1 !== F ? this.getDimensions(F).primaryPos : -1);
					var r;
					for (n = F + 1, i = A.length; i > n; n++)
						if (
							(o = this.getDimensions(n)) &&
							o.primaryPos + o.rowPrimarySize > t
						) {
							if (R)
								for (
									r = o;
									i - 1 > n &&
									(o = this.getDimensions(n + 1)).primaryPos === r.primaryPos;

								)
									n++;
							break;
						}
					(W = Math.min(n, A.length - 1)),
						(X =
							-1 !== W
								? (o = this.getDimensions(W)).primaryPos +
									(o.rowPrimarySize || o.primarySize)
								: -1),
						(l = e),
						(s = F);
				};
			...
			var v,
				...
				R = L
					? k.dynamic || k.value !== B.__clientWidth
					: S.dynamic || S.value !== B.__clientHeight,
			...
			var te = L ? "getContentHeight" : "getContentWidth",
				ne = B.options[te];
			(B.options[te] = angular.bind(ee, ee.getContentSize)),
				(B.__$callback = B.__callback),
				(B.__callback = function(e, t, n, i) {
					var o = ee.getScrollValue();
					(-1 === F || o + ee.scrollPrimarySize > X || Y > o) && a(),
						B.__$callback(e, t, n, i);
				});
			var ie = !1,
				oe = !1;
			(this.refreshLayout = function() {
				...
				var e = getComputedStyle(w) || {},
					n =
						(w.firstElementChild && getComputedStyle(w.firstElementChild)) ||
						{},
					i =
						(w.lastElementChild && getComputedStyle(w.lastElementChild)) || {};
				(U =
					(parseInt(e[L ? "height" : "width"]) || 0) +
					((n && parseInt(n[L ? "marginTop" : "marginLeft"])) || 0) +
					((i && parseInt(i[L ? "marginBottom" : "marginRight"])) || 0)),
					(q = 0);
				var o = b;
				do q += o[L ? "offsetTop" : "offsetLeft"];
				while (ionic.DomUtil.contains(B.__content, (o = o.offsetParent)));
				var a = b.previousElementSibling,
					c = a ? t.getComputedStyle(a) : {},
					l = parseInt(c[L ? "marginBottom" : "marginRight"] || 0);
				if (
					((b.style[ionic.CSS.TRANSFORM] = O.replace(N, -l).replace(z, 0)),
					(q -= l),
					(B.__clientHeight && B.__clientWidth) ||
						((B.__clientWidth = B.__container.clientWidth),
						(B.__clientHeight = B.__container.clientHeight)),
				...
				(ie = !0),
					ie &&
						oe &&
						((B.__scrollLeft > B.__maxScrollLeft ||
							B.__scrollTop > B.__maxScrollTop) &&
							B.resize(),
						r(!0));
			}),
				...
				(this.destroy = function() {
					(a.destroyed = !0),
						...
						(j.length = K.length = G.length = 0),
						(Z = {}),
						(B.options[te] = ne),
						(B.__callback = B.__$callback),
						B.resize(),
			...
			function(t, n) {
				return {
					...
					compile: function(i) {
						function o(t, n, i, o) {
							e
								...
								: (t.$watch(
									...
									o.align(),
									t.$on("$ionicFooter.align", function() {
										ionic.requestAnimationFrame(function() {
											o.align();
										});
									}));
						...
						return (
							i.addClass(e ? "bar bar-header" : "bar bar-footer"),
							n(function() {
								e &&
									t[0].getElementsByClassName("tabs-top").length &&
									i.addClass("has-tabs-top");
							}),
							{ pre: o }
						);
					}
		...
		function(e, t, n, i, o, r, a, s) {
			function l(o) {
				...
				var p = (u.element = t(
					...
					g = u.cancelOnStateChange
						? e.$on("$stateChangeSuccess", function() {
								u.cancel();
							})
						: h;
				return (
					(u.removeSheet = function(e) {
						u.removed ||
							((u.removed = !0),
							v.removeClass("action-sheet-up"),
							i(function() {
								a.removeClass("action-sheet-open");
							}, 400),
							u.$deregisterBackButton(),
							g(),
							n.removeClass(p, "active").then(function() {
								u.$destroy(),
									p.remove(),
					...
					(u.showSheet = function(e) {
						u.removed ||
							(a.append(p).addClass("action-sheet-open"),
							n.addClass(p, "active").then(function() {
								u.removed || (e || h)();
							}),
							i(
								function() {
				...
				for (t = 0; t < this.length; t++)
					if (((o = this[t]), o.setAttribute))
						if (e.indexOf(" ") < 0 && o.classList.add) o.classList.add(e);
							...
							for (
								a = (" " + (o.getAttribute("class") || "") + " ").replace(
									/[\n\t]/g,
									" "
								),
									r = e.split(" "),
		...
		a.factory("$ionicBackdrop", [
			...
			function(e, t, n, i) {
				...
				var c = f('<div class="backdrop">'),
					s = 0;
				return (
					e[0].body.appendChild(c[0]),
					{ retain: o, release: r, getElement: a, _element: c }
				);
			}
		]),
		a.factory("$ionicBind", [
			...
			function(e) {
				return {
					...
					enableClass: function(e) {
						...
						return (
							e
								? this.addClass.apply(this, t)
								: this.removeClass.apply(this, t),
							this
						);
					},
					append: function(t) {
		...
		a
			.factory("$ionicHistory", [
				...
				function(e, t, n, i, o, r, a) {
					...
					function p(t) {
						for (var n = t; n; ) {
							if (n.hasOwnProperty("$historyId"))
								return { historyId: n.$historyId, scope: n };
							n = n.$parent;
						}
					...
					function v(e) {
						(R.currentView = s(e)),
							(R.backView = u(R.currentView)),
							(R.forwardView = d(R.currentView));
					}
					function g() {
						var e;
					...
					function $(e) {
						return (
							e && e.length && /ion-side-menus|ion-tabs/i.test(e[0].tagName)
						);
					}
					function w(e, t) {
						...
						}),
						{
							register: function(e, t) {
								var i,
									...
									U = n.url();
								if ((b !== l && ((b = l), L++), C))
									(z = C.viewId), (O = C.action), (H = C.direction), (C = null);
								else if (M && M.stateId === l)
									(z = M.viewId),
										(q = M.historyId),
										(O = B),
										M.historyId === $.historyId
											...
											: $ &&
												((H = P),
												(i = f(M.historyId)),
												i && i.parentHistoryId === $.historyId
													? (H = E)
													: ((i = f($.historyId)),
														i &&
															i.parentHistoryId === d.parentHistoryId &&
															(H = _)));
								else if (N && N.stateId === l)
									(z = N.viewId),
										(q = N.historyId),
										(O = x),
										...
										N.historyId &&
											i.scope &&
											((i.scope.$historyId = N.historyId), (q = N.historyId));
								else if (
									$ &&
									$.historyId !== q &&
									d.cursor > -1 &&
									d.stack.length > 0 &&
									d.cursor < d.stack.length &&
									d.stack[d.cursor].stateId === l
								) {
									...
									if (
										...
										(H = _),
										(i = f($.historyId)),
										i && i.parentHistoryId === q
											? (H = P)
											: ((i = f(q)),
												i && i.parentHistoryId === $.historyId && (H = E)),
										(i = s(F.backViewId)),
										i && F.historyId !== i.historyId)
									) {
									...
									if (((c = r.createViewEle(t)), this.isAbstractEle(c, t)))
										return { action: "abstractView", direction: D, ele: c };
									if (((z = ionic.Utils.nextUid()), $)) {
										...
										d.historyId === $.historyId
											...
											: $.historyId !== d.historyId &&
												((H = E),
												(i = f($.historyId)),
												i && i.parentHistoryId === d.parentHistoryId
													? (H = _)
													: ((i = f(i.parentHistoryId)),
														i && i.historyId === d.historyId && (H = P)));
									} else O = T;
									2 > L && (H = D),
										(R.views[z] = this.createView({
											viewId: z,
								...
								if ((S && S(), o.cancel(k), y)) {
									if (
										...
										for (a = 0; a < d.stack.length; a++)
											d.stack[a].viewId === z
												? ((d.stack[a].index = 0),
													(d.stack[a].backViewId = d.stack[
														a
													].forwardViewId = null))
												: delete R.views[d.stack[a].viewId];
										d.stack = [R.views[z]];
									}
									y = null;
								}
								if (
									(v(z),
									R.backView &&
										q == R.backView.historyId &&
										l == R.backView.stateId &&
										U == R.backView.url)
								)
									for (a = 0; a < d.stack.length; a++)
										if (d.stack[a].viewId == z) {
											(O = "dupNav"),
												...
												(R.forwardView = null),
												(R.currentView.index = R.backView.index),
												(R.currentView.backViewId = R.backView.backViewId),
												(R.backView = u(R.backView)),
												d.stack.splice(a, 1);
											break;
										}
								return (
									(d.cursor = R.currentView.index),
									{
										viewId: z,
										action: O,
										direction: H,
							...
							currentTitle: function(e) {
								return R.currentView
									? (arguments.length && (R.currentView.title = e),
										R.currentView.title)
									: void 0;
							},
							backView: function(e) {
							...
							goToHistoryRoot: function(e) {
								if (e) {
									...
									if (t && t.stack.length) {
										if (
											R.currentView &&
											R.currentView.viewId === t.stack[0].viewId
										)
											return;
										(C = {
							...
							goBack: function(e) {
								if (l(e) && -1 !== e) {
									...
									for (
										var i = n - 1, r = [], a = s(t.stack[i].forwardViewId);
										a &&
										(r.push(a.stateId || a.viewId),
										i++,
										!(i >= t.stack.length));
							...
							removeBackView: function() {
								...
								o &&
									r &&
									(t.stack.splice(n - 1, 1),
									e.clearCache([o.viewId]),
									(i.backViewId = r.viewId),
									(i.index = i.index - 1),
									(r.forwardViewId = i.viewId),
									(R.backView = r),
									(t.currentCursor += -1));
							},
							...
							clearHistory: function() {
								...
								if (e)
									for (var n in e)
										e[n].stack && ((e[n].stack = []), (e[n].cursor = -1)),
											t && t.historyId === n
												? ((t.backViewId = t.forwardViewId = null),
													e[n].stack.push(t))
												: e[n].destroy && e[n].destroy();
									...
									arguments.length &&
										...
										null === t
											...
											: ((y = y || {}),
												c(y, t),
												y.expire &&
													(S = e.$on("$stateChangeSuccess", function() {
														k = o(function() {
															y = null;
														}, y.expire);
													})))),
							...
							isAbstractEle: function(e, t) {
								return t && t.$$state && t.$$state.self["abstract"]
									? !0
									: !(!e || (!$(e) && !$(e.children())));
							},
								...
								for (var t, n = e, i = this.currentHistoryId(); n; ) {
									...
									if ((!t && n.hasOwnProperty("$historyId") && (t = !0), i)) {
										if (n.hasOwnProperty("$historyId") && i == n.$historyId)
											return !0;
										if (
											n.hasOwnProperty("$activeHistoryId") &&
											i == n.$activeHistoryId
										) {
			...
			.run([
				...
				function(e, t, n, i, o, r, a) {
					function c(e) {
						var t = r.backView();
						return (
							t ? t.go() : ionic.Platform.exitApp(), e.preventDefault(), !1
						);
					}
					e.$on("$ionicView.beforeEnter", function() {
						...
						e.$on("$ionicHistory.change", function(e, i) {
							...
							!i.url && i.uiSref && (i.url = t.href(i.uiSref)),
								i.url &&
									(0 === i.url.indexOf("#") && (i.url = i.url.replace("#", "")),
			...
			.provider("$ionicConfig", function() {
				...
				function t(e, n) {
					for (var i in e)
						i != r &&
							e.hasOwnProperty(i) &&
							(angular.isObject(e[i])
								? (l(n[i]) || (n[i] = {}), t(e[i], n[i]))
								: l(n[i]) || (n[i] = null));
				}
				function n(e, t, o) {
					s(e, function(c, s) {
						angular.isObject(e[s])
							? ((t[s] = {}), n(e[s], t[s], o + "." + s))
							: (t[s] = function(n) {
									...
									if (e[s] == r) {
										var c = i(
											a.platform,
											ionic.Platform.platform() + o + "." + s
										);
										return c || c === !1
											? c
											: i(a.platform, "default" + o + "." + s);
									}
									return e[s];
								});
					});
				...
				n(a, o, ""),
					...
					e("windowsphone", { spinner: { icon: "android" } }),
					(o.transitions = { views: {}, navBar: {} }),
					...
					(o.transitions.navBar.ios = function(e, t, n, i) {
						...
						function r(e, t, n) {
							if (e && t) {
								var i = (e.titleTextX() + e.titleWidth()) * (1 - n),
									r =
										(t &&
											(t.titleTextX() - e.backButtonTextLeft()) * (1 - n)) ||
										0;
								o(e, n, i, r);
							}
						}
						function a(e, t, n) {
							if (e && t) {
								var i =
									(-(e.titleTextX() - t.backButtonTextLeft()) -
										e.titleLeftRight()) *
									n;
								o(e, 1 - n, i, 0);
							}
					...
					(o.transitions.views.android = function(e, t, n, i) {
						function o(e, t, n) {
							var i = {};
							(i[ionic.CSS.TRANSITION_DURATION] = r.shouldAnimate ? "" : 0),
								(i[ionic.CSS.TRANSFORM] = "translate3d(" + t + "%,0,0)"),
								(i.opacity = n),
								ionic.DomUtil.cachedStyles(e, i);
						}
						i = i && ("forward" == n || "back" == n);
						var r = {
							run: function(i) {
								"forward" == n
									? (o(e, 99 * (1 - i), 1), o(t, -100 * i, 1))
									: "back" == n
										? (o(e, -100 * (1 - i), 1), o(t, 100 * i, 1))
										: (o(e, 0, 1), o(t, 0, 0));
							},
							shouldAnimate: i
						};
	...
	a
		...
		.factory("$ionicLoading", [
			...
			"$rootScope",
			"IONIC_BACK_PRIORITY",
			function(e, t, n, i, o, r, a, s, l, u, d) {
				function f() {
					return (
						m ||
							(m = n
								.compile({ template: p, appendTo: t.get() })
								.then(function(e) {
									return (
										(e.show = function(a) {
											var c = a.templateUrl
												? n.load(a.templateUrl)
												: r.when(a.template || a.content || "");
											(e.scope = a.scope || e.scope),
												e.isShown ||
													((e.hasBackdrop =
														!a.noBackdrop && a.showBackdrop !== !1),
													e.hasBackdrop &&
														(i.retain(),
												...
												a.duration &&
													...
													(e.durationTimeout = o(
														angular.bind(e, e.hide),
														+a.duration
													))),
												$(),
												($ = l.registerBackButtonAction(h, d.loading)),
												c.then(function(n) {
													if (n) {
				...
				function v(t) {
					...
					return (
						...
						b(),
						t.hideOnStateChange &&
							((w = u.$on("$stateChangeSuccess", g)),
							(b = u.$on("$stateChangeError", g))),
						o.cancel(y),
						(y = o(h, n)),
						y.then(f).then(function(e) {
							return e.show(t);
						})
					);
				}
				...
				var p = ionic.views.Modal.inherit({
						...
						show: function(e) {
							...
							return (
								...
								(n._isShown = !0),
								(n._deregisterBackButton = o.registerBackButtonAction(
									n.hardwareBackButtonClose ? angular.bind(n, n.hide) : h,
									d.modal
								)),
								ionic.views.Modal.prototype.show.call(n),
								i(function() {
									n._isShown &&
										(r.addClass("ng-enter-active"),
										ionic.trigger("resize"),
										n.scope.$parent &&
											n.scope.$parent.$broadcast(n.viewType + ".shown", n),
										n.el.classList.add("active"),
										n.scope.$broadcast("$ionicHeader.align"),
										n.scope.$broadcast("$ionicFooter.align"),
										n.scope.$broadcast("$ionic.modalPresented"));
								}, 20),
								i(function() {
									n._isShown &&
										(n.$el.on("touchmove", function(e) {
											var t = ionic.DomUtil.getParentOrSelfWithClass(
												e.target,
												"scroll"
											);
											t || e.preventDefault();
						...
						hide: function() {
							...
							return (
								...
								i(
									function() {
										e._isShown ||
											...
											e.scope.$broadcast("$ionic.modalRemoved"));
									},
									20,
									!1
								),
								...
								(e._isShown = !1),
								e.scope.$parent &&
									e.scope.$parent.$broadcast(e.viewType + ".hidden", e),
								e._deregisterBackButton && e._deregisterBackButton(),
								ionic.views.Modal.prototype.hide.call(e),
								e.positionView &&
									ionic.off("resize", e._onWindowResize, window),
								i(function() {
									g.length || t.removeClass(e.viewType + "-open"),
						...
						remove: function() {
							...
							return (
								n.scope.$parent &&
									n.scope.$parent.$broadcast(n.viewType + ".removed", n),
								n._isShown
									? (t = n.hide())
									: ((e = a.defer()), e.resolve(), (t = e.promise)),
								t.then(function() {
					...
					v = function(t, i) {
						...
						var r = n(
							"<ion-" + i.viewType + ">" + t + "</ion-" + i.viewType + ">"
						)(o);
						(i.$el = r),
							(i.el = r[0]),
		...
		a.service("$ionicNavViewDelegate", ionic.DelegateService(["clearCache"])),
		a
						...
						function(e, t) {
							var n = {
								...
								hardwareBackButtonClick: function(e) {
									var t, i;
									for (i in n.$backButtonActions)
										(!t || n.$backButtonActions[i].priority >= t.priority) &&
											(t = n.$backButtonActions[i]);
		...
		a.factory("$ionicPopover", [
			...
			function(e, t, n, i) {
				function o(e, n) {
					...
					d.left < r
						? (d.left = r)
						: d.left + c + r > l && (d.left = l - c - r),
						a.top + a.height + s > u && a.top - s > 0
							? ((d.top = a.top - s), n.addClass("popover-bottom"))
							: ((d.top = a.top + a.height), n.removeClass("popover-bottom")),
						h.css({
							left:
								a.left + a.width / 2 - h.prop("offsetWidth") / 2 - d.left + "px"
						}),
						n.css({
							top: d.top + "px",
							left: d.left + "px",
	...
	a.factory("$ionicPopup", [
		...
		"$ionicModal",
		"IONIC_BACK_PRIORITY",
		function(e, t, n, i, o, r, a, s, l, u) {
			function d(t) {
				t = c({ scope: null, title: "", buttons: [] }, t || {});
				var s = {};
				return (
					(s.scope = (t.scope || o).$new()),
					(s.element = f(v)),
					(s.responseDeferred = n.defer()),
					r.get().appendChild(s.element[0]),
					a(s.element)(s.scope),
					c(s.scope, {
						title: t.title,
						buttons: t.buttons,
					...
					(s.show = function() {
						s.isShown ||
							...
							ionic.requestAnimationFrame(function() {
								s.isShown &&
									(s.element.removeClass("popup-hidden"),
			...
			function g(e) {
				...
				return (
					S.length > 0
						? ((a = y.stackPushDelay), i(S[S.length - 1].hide, a, !1))
						: (r.addClass("popup-open"),
							t.retain(),
							(k._backButtonActionDone = s.registerBackButtonAction(
								p,
								u.popup
							))),
					...
					o.responseDeferred.notify({ close: o.responseDeferred.close }),
					n(),
			...
			function b(e) {
				var t = o.$new(!0);
				(t.data = {}),
					(t.data.fieldtype = e.inputType ? e.inputType : "text"),
					(t.data.response = e.defaultText ? e.defaultText : ""),
					(t.data.placeholder = e.inputPlaceholder ? e.inputPlaceholder : ""),
					(t.data.maxlength = e.maxLength ? parseInt(e.maxLength) : "");
				var n = "";
				return (
					e.template &&
						/<[a-z][\s\S]*>/i.test(e.template) === !1 &&
						((n = "<span>" + e.template + "</span>"), delete e.template),
					g(
						c(
							{
								template:
									n +
									'<input ng-model="data.response" type="{{ data.fieldtype }}"maxlength="{{ data.maxlength }}"placeholder="{{ data.placeholder }}">',
								scope: t,
								buttons: [
									{
										text: e.cancelText || "Cancel",
			...
			function(e, t) {
				function n(e, n) {
					return e.currentStyle
						? e.currentStyle[n]
						: t.getComputedStyle ? t.getComputedStyle(e)[n] : e.style[n];
				}
				function i(e) {
				...
				return {
					position: function(t) {
						...
						r != e[0] &&
							((i = this.offset(f(r))),
							(i.top += r.clientTop - r.scrollTop),
							(i.left += r.clientLeft - r.scrollLeft));
		...
		a.service(
			"$ionicTabsDelegate",
			ionic.DelegateService(["select", "selectedIndex", "showBar"])
		),
		(function() {
			var e = [];
			a
				...
				.config([
					...
					function(t, n) {
						...
						t.state = function(o, r) {
							if ("object" == typeof r) {
								var a =
									r.prefetchTemplate !== !1 &&
									e.length < n.templates.maxPrefetch();
								if (
									(a && d(r.templateUrl) && e.push(r.templateUrl),
									angular.isObject(r.views))
								)
									for (var c in r.views)
										(a =
											r.views[c].prefetchTemplate !== !1 &&
											e.length < n.templates.maxPrefetch()),
											a &&
												d(r.views[c].templateUrl) &&
												e.push(r.views[c].templateUrl);
							}
							return i.call(t, o, r);
						};
					}
			...
			function(e, t, n, i, o, r) {
				...
				function s(n) {
					...
					return r.then(function(i) {
						...
						return (
							n.controller &&
								((r = t(n.controller, c(n.locals, { $scope: a }))),
								s.children().data("$ngControllerController", r)),
							n.appendTo && f(n.appendTo).append(s),
							e(s)(a),
							{ element: s, scope: a }
						);
					});
		...
		a.factory("$ionicViewSwitcher", [
			...
			function(e, t, n, i, o, r) {
				function a(e, t) {
					return u(e)["abstract"]
						? u(e).name
						: t ? t.stateId || t.viewId : ionic.Utils.nextUid();
				}
				function u(e) {
				...
				function d(e, t, n, i) {
					...
					return (
						(n = b || D(t, "view-direction") || r.viewDirection || n || "none"),
						c(h(i), {
							transition: a,
				...
				function v(e) {
					if (e && e.length) {
						var t = e.scope();
						t && (t.$emit("$ionicView.unloaded", e.data(B)), t.$destroy()),
							e.remove();
					}
				}
				function g(e, t) {
				...
				function m(e, t) {
					...
					if ("true" !== n)
						return i === t.stateName ? angular.element(e).scope() : null;
					for (var o = $(e), r = 0; r < o.length; r++) {
						var a = angular.element(o[r]).attr("state");
						if (a === t.stateName)
							return (t.abstractView = !0), angular.element(o[r]).scope();
					}
					return null;
				}
				function $(e) {
					for (
						var t = [], n = angular.element(e).find("ion-nav-view"), i = 0;
						i < n.length;
						i++
					) {
						for (
							var o = angular.element(n[i]).children(), r = [], a = 0;
							a < o.length;
							a++
						)
							r = r.concat(o[a]);
				...
				var _,
					...
					M = {
								...
								q = {
									...
									loadViewElements: function(e) {
										...
										for (
											...
											o.data(C) === c
												? o.data(S)
													? (o.data(C, c + ionic.Utils.nextUid()),
														o.data(k, !0))
													: (N = o)
												: l(u) && o.data(C) === u && (z = o),
											!N || !z);
										...
										(O = !!N),
											O || ((N = e.ele || M.createViewEle(s)), N.data(C, c)),
											_ && t.activeEleId(c),
											(e.ele = null);
									},
									render: function(e, n) {
										if (O) ionic.Utils.reconnectScope(N.scope());
											...
											var i = d(s, N, e.direction, f),
												r =
													o.transitions.views[i.transition] ||
													o.transitions.views.none;
											r(N, null, i.direction, !0).run(0),
												N.data(B, {
													viewId: i.viewId,
									...
									transition: function(a, l, u) {
										function v() {
											p(N, F.shouldAnimate ? "entering" : A),
												p(z, F.shouldAnimate ? "leaving" : V),
												F.run(1),
										...
										var C,
											T = d(s, N, a, f),
											B = c(c({}, T), h($));
										(T.transitionId = B.transitionId = H),
											(T.fromCache = !!O),
											(T.enableBack = !!l),
											(T.renderStart = x),
											(T.renderEnd = _),
											D(N.parent(), "nav-view-transition", T.transition),
											D(N.parent(), "nav-view-direction", T.direction),
											e.cancel(N.data(I));
										var U =
												o.transitions.views[T.transition] ||
												o.transitions.views.none,
											F = U(N, z, T.direction, T.shouldAnimate && u && _);
										if (
											(F.shouldAnimate &&
												(N.on(y, g), N.data(I, e(m, R)), i.show(R)),
											x && (q.emit("before", T, B), p(N, E), F.run(0)),
											_ && ((C = n.defer()), L.push(C.promise)),
											x && _)
										)
											e(function() {
											...
											if (!_)
												return (
													...
													p(z, "leaving"),
													{
														...
														cancel: function(t) {
															t
																? (N.on(y, S), N.data(I, e(k, R)), i.show(R))
																: k(),
																(F.shouldAnimate = t),
																F.run(0),
																(F = null);
									...
									emit: function(e, t, n) {
										var i,
											o = m(N, t),
											r = m(z, n);
										!t.viewId || t.abstractView
											? r &&
												(r.$emit("$ionicView.beforeLeave", n),
												r.$emit("$ionicView.leave", n),
												r.$emit("$ionicView.afterLeave", n),
												r.$broadcast("$ionicParentView.beforeLeave", n),
												r.$broadcast("$ionicParentView.leave", n),
												r.$broadcast("$ionicParentView.afterLeave", n))
											: ("after" == e &&
													(o &&
														(o.$emit("$ionicView.enter", t),
														o.$broadcast("$ionicParentView.enter", t)),
													r
														? (r.$emit("$ionicView.leave", n),
															r.$broadcast("$ionicParentView.leave", n))
														: o &&
															...
															((i = g(t.stateName, n.stateName)),
															i && o.$emit("$ionicNavView.leave", n))),
												o &&
													(o.$emit("$ionicView." + e + "Enter", t),
													o.$broadcast("$ionicParentView." + e + "Enter", t)),
												r
													? (r.$emit("$ionicView." + e + "Leave", n),
														r.$broadcast("$ionicParentView." + e + "Leave", n))
													: o &&
														n &&
														n.viewId &&
														t.stateName !== n.stateName &&
														((i = g(t.stateName, n.stateName)),
														i && o.$emit("$ionicNavView." + e + "Leave", n)));
									},
									cleanup: function(e) {
										z &&
											"back" == e.direction &&
											!o.views.forwardCache() &&
											v(z);
										var n,
											i,
											r,
						...
						createViewEle: function(e) {
							...
							return e &&
							e.$template &&
							((n.innerHTML = e.$template), 1 === n.children.length)
								? (n.children[0].classList.add("pane"),
									e.$$state && e.$$state.self && e.$$state.self["abstract"]
										? angular.element(n.children[0]).attr("abstract", "true")
										: e.$$state &&
											e.$$state.self &&
											angular
												.element(n.children[0])
												.attr("state", e.$$state.self.name),
									f(n.children[0]))
								: ((n.className = "pane"), f(n));
						},
			...
			function(e) {
				...
				e.decorator("$browser", [
					...
					function(e, t) {
						function n(e) {
							return (
								/(iPhone|iPad|iPod).* OS 9_\d/.test(e) &&
								!/Version\/9\./.test(e)
							);
						}
						function i(e) {
							...
							return (
								(e.url = function() {
									return arguments.length
										? ((n = arguments[0]), i.apply(e, arguments))
										: n || i.apply(e, arguments);
								}),
		...
		a.config([
			...
			function(e) {
				e.decorator("$compile", [
					...
					function(e) {
						return (
							(e.$$addScopeInfo = function(e, t, n, i) {
								var o = n
									? i ? "$isolateScopeNoTemplate" : "$isolateScope"
									: "$scope";
								e.data(o, t);
							}),
							e
			...
			function(e, t, n, i, o, r) {
				...
				(h.beforeEnter = function(t) {
					...
					(h.updateBackButton = function() {
						...
						(b && y && w) !== S &&
							...
							w &&
								((e = e || a(l)),
								e &&
									(h.backButtonIcon !== o.backButton.icon() &&
										((e = a(l + " .icon")),
										e &&
											((h.backButtonIcon = o.backButton.icon()),
											(e.className = "icon " + h.backButtonIcon))),
									h.backButtonText !== o.backButton.text() &&
										((e = a(l + " .back-text")),
										e &&
											(e.textContent = h.backButtonText = o.backButton.text()))));
					}),
					(h.titleTextWidth = function() {
						var e = a(c);
						if (e)
							for (
								var t = angular.element(e).children(), n = 0;
								n < t.length;
								n++
							)
					...
					(h.calcWidths = function(e, n) {
						...
						for (i = 0; i < S.length; i++) {
							if (((p = S[i]), (g = 0), 1 == p.nodeType)) {
								...
								if (b && p === y) {
									for (o = 0; o < p.childNodes.length; o++)
										if (((h = p.childNodes[o]), 1 == h.nodeType))
											...
											3 == h.nodeType &&
												h.nodeValue.trim() &&
												((m = ionic.DomUtil.getTextBounds(h)),
												(x += (m && m.width) || 0));
									g = x || p.offsetWidth;
								...
								3 == p.nodeType &&
									p.nodeValue.trim() &&
									((m = ionic.DomUtil.getTextBounds(p)),
									(g = (m && m.width) || 0));
							$ ? (C += g) : (k += g);
						}
						if ("left" == e)
							(B = "title-left"), k && (T = k + 15), C && (I = C + 15);
						else if ("right" == e)
							(B = "title-right"), k && (T = k + 15), C && (I = C + 15);
						else {
					...
					(h.updatePositions = function(e, n, r, c, s, l, p) {
						...
						if (
							(e &&
								(n !== g && ((e.style.left = n ? n + "px" : ""), (g = n)),
								r !== m && ((e.style.right = r ? r + "px" : ""), (m = r)),
								l !== $ &&
									(l && e.classList.add(l),
									$ && e.classList.remove($),
									($ = l))),
							o.backButton.previousTitleText())
						) {
							var w = a(d),
								b = a(u);
		...
		a.controller("$ionInfiniteScroll", [
			"$scope",
			"$attrs",
			"$element",
			"$timeout",
			function(e, t, n, i) {
						...
						i(
							function() {
								s.jsScrolling && s.scrollView.resize(),
									((s.jsScrolling &&
										s.scrollView.__container &&
										s.scrollView.__container.offsetHeight > 0) ||
										!s.jsScrolling) &&
										s.checkBounds();
							},
							30,
				...
				function a() {
					if (!s.isLoading) {
						...
						if (s.jsScrolling) {
							...
							((-1 !== e.left && t.left >= e.left) ||
								(-1 !== e.top && t.top >= e.top)) &&
								o();
						} else
							(e = s.getNativeMaxScroll()),
								((-1 !== e.left &&
									s.scrollEl.scrollLeft >= e.left - s.scrollEl.clientWidth) ||
									(-1 !== e.top &&
										s.scrollEl.scrollTop >= e.top - s.scrollEl.clientHeight)) &&
									o();
					}
				}
				function c(e) {
				...
				(s.isLoading = !1),
					...
					e.$on("$destroy", function() {
						s.scrollCtrl &&
							s.scrollCtrl.$element &&
							s.scrollCtrl.$element.off("scroll", s.checkBounds),
							s.scrollEl &&
								s.scrollEl.removeEventListener &&
								s.scrollEl.removeEventListener("scroll", s.checkBounds);
					}),
					...
					(s.getNativeMaxScroll = function() {
						...
						return {
							left:
								...
								("scroll" !== t.overflowX &&
									"auto" !== t.overflowX &&
									"scroll" !== s.scrollEl.style["overflow-x"])
									? -1
									: c(e.left),
							top:
								!e.top ||
								("scroll" !== t.overflowY &&
									"auto" !== t.overflowY &&
									"scroll" !== s.scrollEl.style["overflow-y"])
									? -1
									: c(e.top)
						};
					}),
			...
			function(e, t, n, i, o, r, a, c) {
				...
				(I.init = function() {
						...
						function r(e, t) {
							e &&
								("title" === t
									? g.append(e)
									: "rightButtons" == t ||
										(t == k && "left" != a.navBar.positionSecondaryButtons()) ||
										(t == S && "right" == a.navBar.positionPrimaryButtons())
										? (v ||
												((v = f('<div class="buttons buttons-right">')),
												h.append(v)),
											t == k ? v.append(e) : v.prepend(e))
										: (p ||
												((p = f('<div class="buttons buttons-left">')),
												m[C] ? m[C].after(p) : h.prepend(p)),
											t == k ? p.append(e) : p.prepend(e)));
						}
					...
					(I.transition = function(n, i, r) {
						function c() {
							...
							(n.isActive = !0),
								v(n, "active"),
								v(i, "cached"),
								(I.activeTransition = d = $ = null);
						}
						var s = n.controller(),
							l =
								a.transitions.navBar[r.navBarTransition] ||
								a.transitions.navBar.none,
							u = r.transitionId;
						s.beforeEnter(r);
						...
						ionic.DomUtil.cachedAttr(
							...
							d.shouldAnimate && r.renderEnd
								? v(n, "stage")
								: (v(n, "entering"), v(i, "leaving")),
							s.resetBackButton(r),
							d.run(0),
							(I.activeTransition = {
								run: function(e) {
								...
								cancel: function(t, o, r) {
									g(o),
										...
										(I.activeTransition = d = null);
									var a;
									r.showBar !== I.showBar() && I.showBar(r.showBar),
										r.showBackButton !== I.showBackButton() &&
											I.showBackButton(r.showBackButton),
										a && e.$apply();
								},
					...
					(I.showBar = function(t) {
						return (
							arguments.length &&
								(I.visibleBar(t), (e.$parent.$hasHeader = !!t)),
							!!e.$parent.$hasHeader
						);
					}),
					(I.visibleBar = function(e) {
						e && !A ? (t.removeClass(b), I.align()) : !e && A && t.addClass(b),
							(A = e);
					}),
					(I.enable = function(e) {
						I.visibleBar(e);
						for (var t = 0; t < r._instances.length; t++)
					...
					(I.showActiveBackButton = function(e) {
						...
						return t
							? arguments.length
								? t.controller().showBack(e)
								: t.controller().showBack()
							: void 0;
					}),
				...
				(x.scope = e),
					...
					(x.init = function() {
						...
						return (
							...
							e.$on("$ionicHistory.deselect", x.cacheCleanup),
							e.$on("$ionicTabs.top", v),
							e.$on("$ionicSubheader", g),
							e.$on("$ionicTabs.beforeLeave", h),
							e.$on("$ionicTabs.afterLeave", h),
							e.$on("$ionicTabs.leave", h),
							ionic.Platform.ready(function() {
					...
					(x.transitionEnd = function() {
						...
						for (e = 0, n = o.length; n > e; e++)
							(i = o.eq(e)),
								i.data(k) === b
									? V(i, I)
									: ("leaving" === V(i) || V(i) === I || V(i) === B) &&
										(i.data(C) || i.data(T)
											? l.destroyViewEle(i)
											: (V(i, B), ionic.Utils.disconnectScope(i.scope())));
					...
					(x.clearCache = function(e) {
						...
						for (o = 0, r = s.length; r > o; o++)
							if (((n = s.eq(o)), e))
								for (c = n.data(k), a = 0; a < e.length; a++)
					...
					(x.appendViewElement = function(n, r) {
						...
						if (r && r.$$controller) {
							...
							r.$$controllerAs && (c[r.$$controllerAs] = s),
					...
					(x.initSwipeBack = function() {
						function n(e) {
							if (
								...
								if (v && v.historyId === n.historyId && n.canSwipeBack !== !1) {
									b || (b = window.innerWidth),
										(x.isSwipeFreeze = d.freezeAllScrolls(!0));
									...
									p.loadViewElements(a),
										p.render(a),
										(c = p.transition("back", s.enabledBack(v), !0)),
										(h = m()),
										($ = ionic.onGesture("drag", i, t[0])),
										(w = ionic.onGesture("release", o, t[0]));
								}
							}
						}
						function i(e) {
							if (A && c) {
								var t = r(e);
								if ((C.push({ t: Date.now(), x: t }), t >= b - 15)) o(e);
								else {
									var n = Math.min(Math.max(a(t), 0), 1);
									c.run(n),
										h && h.activeTransition && h.activeTransition.run(n);
								}
							}
						}
						function o(e) {
							if (A && c && C && C.length > 1) {
								...
								if (
									...
									var m = g > 0.5 || 0.05 > g || n > b - 45 ? "fast" : "slow";
									p(S ? "" : m),
										v.go(),
										h &&
											h.activeTransition &&
											h.activeTransition.complete(!S, m);
								} else
									p(S ? "" : "fast"),
										(y = null),
										c.cancel(!S),
										h &&
											h.activeTransition &&
											h.activeTransition.cancel(!S, "fast", I),
										(S = null);
							}
							ionic.offGesture($, "drag", i),
								ionic.offGesture(w, "release", o),
								(b = c = C = null),
								(x.isSwipeFreeze = d.freezeAllScrolls(!1));
						}
						function r(e) {
						...
						var c,
							...
							I = {};
						(g = ionic.onGesture("dragstart", n, t[0])),
							e.$on("$destroy", function() {
								ionic.offGesture(g, "dragstart", n),
									ionic.offGesture($, "drag", i),
									ionic.offGesture(w, "release", o),
									(x.element = c = h = null);
							});
			...
			function(e, t, n, i, o) {
				...
				function s(e) {
					if (
						...
						if (
							(null === P && (P = e.touches[0].screenY),
							(_ = e.touches[0].screenY - P),
							ionic.Platform.isAndroid() &&
								4.4 === ionic.Platform.version() &&
						...
						_ > 0 && 0 === S.scrollTop && !I && (B = _),
							e.preventDefault(),
							I || ((I = !0), h(!0)),
							(T = !0),
							d((_ - B) / 3),
							!V && x > A
								? ((V = !0), ionic.requestAnimationFrame(g))
								: V && A > x && ((V = !1), ionic.requestAnimationFrame(m));
					}
				}
				function u(e) {
				...
				function d(e) {
					(k.style[ionic.CSS.TRANSFORM] = "translate3d(0px, " + e + "px, 0px)"),
						(x = e);
				}
				function f(e, t) {
					e.scrollTop = t;
				...
				function p(e, t, n) {
					...
					function o() {
						var c = Date.now(),
							s = Math.min(1, (c - r) / t),
							l = i(s);
						d(Math.floor(l * (e - a) + a)),
							1 > s
								? ionic.requestAnimationFrame(o)
								: (5 > e && e > -5 && ((I = !1), h(!1)), n && n());
					}
					var r = Date.now(),
						a = x;
				...
				function v() {
					k &&
						...
						ionic.off(R, s, k),
						ionic.off(M, c, k),
						ionic.off("mousedown", r, k),
						ionic.off("mousemove", s, k),
						ionic.off("mouseup", c, k)),
						S && ionic.off("scroll", u, S),
						(S = null),
						(k = null);
				}
				function g() {
				...
				var S,
					...
					_ = null,
					D = !0;
				l(t.pullingIcon) || t.$set("pullingIcon", "ion-android-arrow-down"),
					(e.showSpinner = !l(t.refreshingIcon) && "none" != t.spinner),
					(e.showIcon = l(t.refreshingIcon)),
					i(e, t, {
						pullingIcon: "@",
						pullingText: "@",
						refreshingIcon: "@",
				...
				var L, R, M;
				window.navigator.pointerEnabled
					? ((L = "pointerdown"), (R = "pointermove"), (M = "pointerup"))
					: window.navigator.msPointerEnabled
						? ((L = "MSPointerDown"),
							(R = "MSPointerMove"),
							(M = "MSPointerUp"))
						: ((L = "touchstart"), (R = "touchmove"), (M = "touchend")),
					(C.init = function() {
						if (
							((S = n.parent().parent()[0]),
							(k = n.parent()[0]),
							!(
								S &&
								S.classList.contains("ionic-scroll") &&
								k &&
								k.classList.contains("scroll")
							))
						)
							throw new Error(
						...
						ionic.on(L, a, k),
							ionic.on(R, s, k),
							ionic.on(M, c, k),
							ionic.on("mousedown", r, k),
							ionic.on("mousemove", s, k),
							ionic.on("mouseup", c, k),
							ionic.on("scroll", u, S),
							e.$on("$destroy", v);
					}),
					...
					(C.__handleTouchmove = s),
					(C.__getScrollChild = function() {
						return k;
					}),
		...
		a.controller("$ionicScroll", [
			...
			function(e, t, n, i, o, r, a, c) {
				...
				var u,
					...
					h = (s.$element = f(d));
				(u = s.isNative()
					? (s.scrollView = new ionic.views.ScrollNative(t))
					: (s.scrollView = new ionic.views.Scroll(t))),
					(h.parent().length ? h.parent() : h).data(
				...
				l(t.bouncing) ||
					ionic.Platform.ready(function() {
						u &&
							u.options &&
							((u.options.bouncing = !0),
							ionic.Platform.isAndroid() &&
								((u.options.bouncing = !1), (u.options.deceleration = 0.95)));
					});
				...
				h.on("scroll", g),
					e.$on("$destroy", function() {
						p(),
							u && u.__cleanup && u.__cleanup(),
							angular.element(i).off("resize", v),
							h && h.off("scroll", g),
							s._scrollViewOptions && (s._scrollViewOptions.el = null),
							t && (t.el = null),
							(u = s.scrollView = t = s._scrollViewOptions = d = s.$element = h = null);
					}),
					n(function() {
						u && u.run && u.run();
					}),
					...
					(s.freezeScroll = u.freeze),
					(s.freezeScrollShut = u.freezeShut),
				...
				($.$scope = e),
					($.initialize = function(e) {
						($.left = e.left),
							...
							($.dragThresholdX = e.dragThresholdX || 10),
							r.registerHistory($.$scope);
					}),
					...
					($.toggleRight = function(e) {
						if (!m && $.right.isEnabled) {
							...
							0 === arguments.length && (e = t >= 0),
								...
								e
									? ($.openPercentage(-100),
										s.$emit("$ionicSideMenuOpen", "right"))
									: ($.openPercentage(0),
					...
					($.openPercentage = function(e) {
						var t = e / 100;
						$.left && e >= 0
							? $.openAmount($.left.width * t)
							: $.right && 0 > e && $.openAmount($.right.width * t),
							o.enableClass(0 !== e, "menu-open"),
							$.content.setCanScroll(0 == e);
					}),
					($.openAmount = function(e) {
						var t = ($.left && $.left.width) || 0,
							n = ($.right && $.right.width) || 0;
						return (($.left && $.left.isEnabled) || !(e > 0)) &&
						(($.right && $.right.isEnabled) || !(0 > e))
							? d && e > t
								? void $.content.setTranslateX(t)
								: l && -n > e
									? void $.content.setTranslateX(-n)
									: ($.content.setTranslateX(e),
										(d = e > 0),
										(l = 0 > e),
										void (e > 0
											? ($.right && $.right.pushDown && $.right.pushDown(),
												$.left && $.left.bringUp && $.left.bringUp())
											: ($.right && $.right.bringUp && $.right.bringUp(),
												$.left && $.left.pushDown && $.left.pushDown())))
					...
					($.snapToRest = function(e) {
						...
						t > 0 && 0.5 > t && "right" == o && n > i
							? $.openPercentage(0)
							: t > 0.5 && "left" == o && n > i
								? $.openPercentage(100)
								: 0 > t && t > -0.5 && "left" == o && n > i
									? $.openPercentage(0)
									: 0.5 > t && "right" == o && n > i
										? $.openPercentage(-100)
										: "right" == o && t >= 0 && (t >= 0.5 || i > n)
											? $.openPercentage(100)
											: "left" == o && 0 >= t && (-0.5 >= t || i > n)
												? $.openPercentage(-100)
												: $.openPercentage(0);
					}),
					...
					($.exposeAside = function(e) {
						(($.left && $.left.isEnabled) || ($.right && $.right.isEnabled)) &&
							($.close(),
							(m = e),
							$.left && $.left.isEnabled && $.right && $.right.isEnabled
								...
								: $.left && $.left.isEnabled
									? $.content.setMarginLeft(m ? $.left.width : 0)
									: $.right &&
										$.right.isEnabled &&
										$.content.setMarginRight(m ? $.right.width : 0),
							$.$scope.$emit("$ionicExposeAside", m));
					}),
					...
					($._handleDrag = function(t) {
						!m &&
							e.dragContent &&
							(p
								? (v = t.gesture.touches[0].pageX)
								: ((p = t.gesture.touches[0].pageX), (v = p)),
							!f &&
								Math.abs(v - p) > $.dragThresholdX &&
								((p = v),
								(f = !0),
					...
					($.edgeThreshold = 25),
					($.edgeThresholdEnabled = !1),
					($.edgeDragThreshold = function(e) {
						return (
							arguments.length &&
								(u(e) && e > 0
									? (($.edgeThreshold = e), ($.edgeThresholdEnabled = !0))
									: ($.edgeThresholdEnabled = !!e)),
					...
					($.isDraggableTarget = function(t) {
						var n = $.edgeThresholdEnabled && !$.isOpen(),
							i =
								t.gesture.startEvent &&
								t.gesture.startEvent.center &&
								t.gesture.startEvent.center.pageX,
							o =
								!n ||
								i <= $.edgeThreshold ||
								i >= $.content.element.offsetWidth - $.edgeThreshold,
							a = r.backView(),
							c = w ? !0 : !a;
						if (!c) {
							var s = r.currentView() || {};
						...
						return (
							(e.dragContent || $.isOpen()) &&
							o &&
							!t.gesture.srcEvent.defaultPrevented &&
							c &&
							!t.target.tagName.match(/input|textarea|select|object|embed/i) &&
							!t.target.isContentEditable &&
							!(t.target.dataset
								? t.target.dataset.preventScroll
								: "true" == t.target.getAttribute("data-prevent-scroll"))
						);
					}),
		...
		(function(e) {
			...
			var r = "translate(32,32)",
				...
				v = {
					android: {
						c: [{ sw: 6, da: 128, os: 82, r: 26, cx: 32, cy: 32, f: d }]
					},
					ios: p,
					"ios-small": p,
					bubbles: {
					...
					crescent: {
						c: [
							{ sw: 4, da: 128, os: 82, r: 26, cx: 32, cy: 32, f: d, at: [h] }
						]
					},
					dots: {
						c: [
						...
						function i() {
							if (!r.stop) {
								var t = o(Date.now() - a, 650),
									...
									p = 182 - 182 * t;
								c % 2 &&
									((d = -1), (f = -64), (h = 128 - -58 * t), (p = 182 * t));
								var v = [0, -101, -90, -11, -180, 79, -270, -191][c];
								n(u, "da", Math.max(Math.min(h, 188), 128)),
									n(u, "os", Math.max(Math.min(p, 182), 0)),
									n(
										u,
										"t",
										"scale(" +
									...
									(s += 4.1),
									s > 359 && (s = 0),
									n(l, "t", "rotate(" + s + ",32,32)"),
									t >= 1 && (c++, c > 7 && (c = 0), (a = Date.now())),
			...
			a.controller("$ionicSpinner", [
				...
				function(e, n, i) {
					...
					(this.init = function() {
						...
						var r = document.createElement("div");
						return (
							t("svg", { viewBox: "0 0 64 64", g: [v[o]] }, r, o),
							e.html(r.innerHTML),
							this.start(),
							o
						);
				...
				(this.$scope = e),
					(this.hrefMatchesState = function() {
						return (
							n.href &&
							0 ===
								i.path().indexOf(n.href.replace(/^#/, "").replace(/\/$/, ""))
						);
					}),
					...
					(this.navNameMatchesState = function() {
						return (
							this.navViewName && t.isCurrentStateNavView(this.navViewName)
						);
					}),
				...
				(o.tabs = []),
					...
					(o.select = function(t, a) {
						...
						1 === arguments.length && (a = !(!t.navViewName && !t.uiSref)),
							r && r.$historyId == t.$historyId
								? a && n.goToHistoryRoot(t.$historyId)
								: i !== c &&
									(s(o.tabs, function(e) {
										o.deselect(e);
									}),
									...
									o.$scope &&
										o.$scope.$parent &&
										(o.$scope.$parent.$activeHistoryId = t.$historyId),
									(t.$tabSelected = !0),
									(t.onSelect || h)(),
									a &&
										e.$emit("$ionicHistory.change", {
											type: "tab",
											tabIndex: c,
											historyId: t.$historyId,
					...
					(o.showBar = function(e) {
						return (
							arguments.length &&
								(e
									? t.removeClass("tabs-item-hide")
									: t.addClass("tabs-item-hide"),
								(c = !!e)),
							c
						);
					});
			...
			function(e, t, n, i, o) {
				...
				(g.init = function() {
					...
					(f = t.inheritedData("$ionNavViewController")),
						f &&
							!n &&
							(e.$on("$ionicView.beforeEnter", g.beforeEnter),
							e.$on("$ionicView.afterEnter", r),
					...
					(g.beforeEnter = function(t, i) {
						if (i && !i.viewNotified) {
							(i.viewNotified = !0),
								o.$$phase || e.$digest(),
								(v = l(n.viewTitle) ? n.viewTitle : n.title);
							var r = {};
		...
		a.directive("ionActionSheet", [
			...
			function(e) {
				return {
					...
					template:
						'<div class="action-sheet-backdrop"><div class="action-sheet-wrapper"><div class="action-sheet" ng-class="{\'action-sheet-has-icons\': $actionSheetHasIcon}"><div class="action-sheet-group action-sheet-options"><div class="action-sheet-title" ng-if="titleText" ng-bind-html="titleText"></div><button class="button action-sheet-option" ng-click="buttonClicked($index)" ng-class="b.className" ng-repeat="b in buttons" ng-bind-html="b.text"></button><button class="button destructive action-sheet-destructive" ng-if="destructiveText" ng-click="destructiveButtonClicked()" ng-bind-html="destructiveText"></button></div><div class="action-sheet-group action-sheet-cancel" ng-if="cancelText"><button class="button" ng-click="cancel()" ng-bind-html="cancelText"></button></div></div></div></div>'
				};
			}
		]),
		a.directive("ionCheckbox", [
			"$ionicConfig",
			function(e) {
				return {
					restrict: "E",
					...
					transclude: !0,
					template:
						'<label class="item item-checkbox"><div class="checkbox checkbox-input-hidden disable-pointer-events"><input type="checkbox"><i class="checkbox-icon"></i></div><div class="item-content disable-pointer-events" ng-transclude></div></label>',
				...
				return {
					...
					compile: function(e, o) {
						function r(e, i, r) {
							...
							if (
								(e.$watch(
									function() {
										return (
											(d.$hasHeader ? " has-header" : "") +
											(d.$hasSubheader ? " has-subheader" : "") +
											(d.$hasFooter ? " has-footer" : "") +
											(d.$hasSubfooter ? " has-subfooter" : "") +
											(d.$hasTabs ? " has-tabs" : "") +
											(d.$hasTabsTop ? " has-tabs-top" : "")
										);
									},
									function(e, t) {
								...
								s
									...
									: (f = {
											...
											scrollEventInterval:
												parseInt(e.scrollEventInterval, 10) || 10,
											scrollingComplete: u
										}),
									(c = t("$ionicScroll", { $scope: e, scrollViewOptions: f })),
									(e.scrollCtrl = c),
									e.$on("$destroy", function() {
										f && ((f.scrollingComplete = h), delete f.el),
											(a = null),
											(i = null),
											(o.$$element = null);
									});
						...
						e.addClass("scroll-content ionic-scroll"),
							"false" != o.scroll
								? ((a = f('<div class="scroll"></div>')),
									a.append(e.contents()),
									e.append(a))
								: e.addClass("scroll-content-false");
						var s =
							"false" !== o.overflowScroll &&
							("true" === o.overflowScroll || !i.scrolling.jsScrolling());
						return (
							s && (s = !e[0].querySelector("[collection-repeat]")), { pre: r }
						);
					}
				};
			}
		]),
		a.directive("exposeAsideWhen", [
			"$window",
			function(e) {
				return {
					restrict: "A",
					...
					link: function(t, n, i, o) {
						...
						ionic.on(
							"resize",
							function() {
								(c !== e.innerWidth || s !== e.innerHeight) &&
									((c = e.innerWidth), (s = e.innerHeight), a());
							},
							e
						);
						var l = ionic.debounce(
							function() {
								t.$apply(r);
							},
							300,
	...
	w.forEach(function(e) {
		...
		a.directive("ionHeaderBar", i(!0)).directive("ionFooterBar", i(!1)),
		a.directive("ionInfiniteScroll", [
			"$timeout",
			function(e) {
				return {
					restrict: "E",
					...
					link: function(t, n, i, o) {
						...
						if (c)
							(r.scrollView = a.scrollView),
								(t.scrollingType = "js-scrolling"),
								a.$element.on("scroll", r.checkBounds);
						else {
							var s = ionic.DomUtil.getParentOrSelfWithClass(
								n[0].parentNode,
								"overflow-scroll"
							);
							if (((r.scrollEl = s), !s))
			...
			return {
				...
				controller: [
					...
					function(e, t) {
						(this.$scope = e),
							(this.$element = t),
							(this.setInputAriaLabeledBy = function(e) {
					...
					compile: function(t, n) {
						...
						if (o) {
							...
							r.addClass("item-content"),
								(l(n.href) || l(n.ngHref)) &&
									(r.attr("ng-href", "{{$href()}}"),
									l(n.target) && r.attr("target", "{{$target()}}")),
								r.append(t.contents()),
						...
						return function(t, n, i) {
							...
							o &&
								t.$on("$collectionRepeatLeave", function() {
									o &&
										o.$$ionicOptionsOpen &&
										((o.style[ionic.CSS.TRANSFORM] = ""),
										(o.style[ionic.CSS.TRANSITION] = "none"),
										e(function() {
	...
	a.directive("ionDeleteButton", function() {
		...
		return {
			...
			compile: function(t, n) {
				return (
					n.$set("class", (n["class"] || "") + " button icon button-icon", !0),
					function(t, n, i, o) {
						function r() {
			...
			return {
				...
				link: function(e, t) {
					...
					if (i && o) {
						var r = function() {
							i.value
								? o.classList.add("has-input")
								: o.classList.remove("has-input");
						};
	...
	a.directive("ionOptionButton", [
		function() {
			...
			return {
				...
				compile: function(t, n) {
					return (
						n.$set("class", (n["class"] || "") + " button", !0),
						function(t, n, i, o) {
							o.optionsContainer ||
								((o.optionsContainer = f(S)),
								o.$element.prepend(o.optionsContainer)),
								o.optionsContainer.prepend(n),
	...
	a.directive("ionReorderButton", [
			...
			return {
				...
				compile: function(t, n) {
					return (
						n.$set(
							"class",
							(n["class"] || "") + " button icon button-icon",
							!0
						),
							...
							function(t, i, o, r) {
								function a() {
									...
									t.$on("$destroy", function() {
										...
										l(n.canSwipe) &&
											t.$watch("!!(" + n.canSwipe + ")", function(e) {
												c.canSwipeItems(e);
											}),
										l(n.showDelete) &&
											t.$watch("!!(" + n.showDelete + ")", function(e) {
												c.showDelete(e);
											}),
										l(n.showReorder) &&
											t.$watch("!!(" + n.showReorder + ")", function(e) {
												c.showReorder(e);
											}),
										t.$watch(
											function() {
											...
											function(e, t) {
												if (e || t) {
													e && c.closeOptionButtons(),
														...
														i.toggleClass("disable-pointer-events", e);
													var n = f(
														i[0].getElementsByClassName("item-reorder")
													);
													o(n, c.showReorder);
												}
											}
		...
		a.directive("ionModal", [
			function() {
				return {
					...
					controller: [function() {}],
					template:
						'<div class="modal-backdrop"><div class="modal-backdrop-bg"></div><div class="modal-wrapper" ng-transclude></div></div>'
				};
			}
		]),
				...
				return {
					...
					compile: function(n, i) {
						...
						i.ngClick || r.setAttribute("ng-click", "$ionicGoBack()"),
							(r.className =
								"button back-button hide buttons " + (n.attr("class") || "")),
							(r.innerHTML = n.html() || "");
						for (
							var c, s, l, u, d = o(n[0]), f = 0;
							f < n[0].childNodes.length;
							f++
						)
							(c = n[0].childNodes[f]),
								1 === c.nodeType
									? o(c)
										? (d = !0)
										: c.classList.contains("default-title")
											? (l = !0)
											: c.classList.contains("previous-title") && (u = !0)
									: s || 3 !== c.nodeType || (s = !!c.nodeValue.trim());
						...
						if (
							(!d &&
								...
								"none" !== h &&
								((r.innerHTML =
									'<i class="icon ' + h + '"></i> ' + r.innerHTML),
								(r.className += " button-clear")),
							!s)
						) {
							...
							(p.className = "back-text"),
								!l &&
									...
									(p.innerHTML +=
										...
										"</span>"),
								!u &&
									e.backButton.previousTitleText() &&
									(p.innerHTML += '<span class="previous-title"></span>'),
								r.appendChild(p);
						}
						return (
							n.attr("class", "hide"),
		...
		a.directive("ionNavButtons", [
			...
			function(e) {
				return {
					...
					compile: function(t, n) {
						var i = "left";
						/^primary|secondary|right$/i.test(n.side || "") &&
							(i = n.side.toLowerCase());
						...
						return (
							...
							t.empty(),
							{
								pre: function(e, t, n, i) {
									...
									a
										? a.navElement(r, o.outerHTML)
										: i.navElement(r, o.outerHTML),
										(o = null);
								}
							}
						);
						...
						return (
							...
							t.empty(),
							{
								pre: function(e, t, n, r) {
									var a = t.parent().data("$ionViewController");
									a
										? a.navElement(i, o.outerHTML)
										: r.navElement(i, o.outerHTML),
										(o = null);
								}
							}
						);
						...
						return (
							...
							function(t, n, i, r) {
								function a(t) {
									...
									n &&
										(t || n !== c) &&
										((c = n), (s.state = n.$$state), r.register(n));
								}
								var c;
								o(t, function(e) {
									n.append(e);
		...
		a.directive("ionPopover", [
			function() {
				return {
					...
					controller: [function() {}],
					template:
						'<div class="popover-backdrop"><div class="popover-wrapper" ng-transclude></div></div>'
				};
			}
		]),
		...
		a.directive("ionRadio", function() {
			return {
				...
				transclude: !0,
				template:
					'<label class="item item-radio"><input type="radio" name="radio-group"><div class="radio-content"><div class="item-content disable-pointer-events" ng-transclude></div><i class="radio-icon disable-pointer-events icon ion-checkmark"></i></div></label>',
					...
					compile: function(e, o) {
						function r(e, i, o) {
							...
							var u = {
								...
								minZoom: e.$eval(e.minZoom) || 0.5,
								preventDefault: !0,
								nativeScrolling: c,
								scrollingComplete: r
							};
							s && ((u.speedMultiplier = 0.8), (u.bouncing = !1));
							var d = t("$ionicScroll", { $scope: e, scrollViewOptions: u });
						}
		...
		a.directive("ionSideMenu", function() {
			return {
				...
				compile: function(e, t) {
					return (
						angular.isUndefined(t.isEnabled) && t.$set("isEnabled", "true"),
		...
		a.directive("ionSideMenuContent", [
			"$timeout",
			"$ionicGesture",
			"$window",
			function(e, t, n) {
					...
					compile: function(i, o) {
						function r(r, a, c, s) {
							function u(e) {
								0 !== s.getOpenAmount()
									? (s.close(),
										...
										(v = null),
										(g = null))
									: v || (v = ionic.tap.pointerCoord(e.gesture.srcEvent));
							}
							function d(e) {
								s.isDraggableTarget(e) &&
									"x" == p(e) &&
									(s._handleDrag(e), e.gesture.srcEvent.preventDefault());
							}
							function f(e) {
							...
							var v = null,
								g = null;
							l(o.dragContent)
								? r.$watch(o.dragContent, function(e) {
										s.canDragContent(e);
									})
								: s.canDragContent(!0),
								l(o.edgeDragThreshold) &&
									r.$watch(o.edgeDragThreshold, function(e) {
							...
							var m = {
								...
								setMarginLeftAndRight: ionic.animationFrameThrottle(function(
									...
									i > 0
										? ((a[0].style[ionic.CSS.TRANSFORM] =
												"translate3d(" + e + "px,0,0)"),
											(a[0].style.width = n.innerWidth - i + "px"),
											(m.offsetX = e))
										: ((a[0].style[ionic.CSS.TRANSFORM] = "translate3d(0,0,0)"),
											(a[0].style.width = ""),
											(m.offsetX = 0));
					...
					return {
						...
						controller: [
							...
							function(e, n, a) {
								function c(e) {
									e && !s.isScrollFreeze
										? r.freezeAllScrolls(e)
										: !e && s.isScrollFreeze && r.freezeAllScrolls(!1),
										(s.isScrollFreeze = e);
								}
								var s = this,
									...
									p = new ionic.views.Slider({
										...
										callback: function(n) {
											(e.currentSlide = n),
												...
												e.$parent.$broadcast("slideBox.slideChanged", n),
												(e.activeSlide = n),
												t(function() {});
										},
										onDrag: function() {
								...
								p.enableSlide(e.$eval(a.disableScroll) !== !0),
									e.$watch("activeSlide", function(e) {
										l(e) && p.slide(e);
									}),
						...
						template:
							'<div class="slider"><div class="slider-slides" ng-transclude></div></div>',
						link: function(t, i, o) {
							function r() {
								if (!a) {
									var e = t.$new();
									(a = f("<ion-pager></ion-pager>")),
										i.append(a),
										(a = n(a)(e));
								}
								return a;
							...
							e.enabled(i, !1),
								l(o.showPager) ||
									((t.showPager = !0), r().toggleClass("hide", !1)),
								o.$observe("showPager", function(e) {
									void 0 !== e &&
										((e = t.$eval(e)), r().toggleClass("hide", !e));
								});
							var a;
						}
					};
			...
			.directive("ionSlides", [
				...
				function(e, t, n) {
					return {
						...
						template:
							'<div class="swiper-container"><div class="swiper-wrapper" ng-transclude></div><div ng-hide="!showPager" class="swiper-pagination"></div></div>',
						controller: [
							"$scope",
							"$element",
							function(e, i) {
								...
								(this.update = function() {
									t(function() {
										if (o.__slider) {
											o.__slider.update(),
												o._options.loop && o.__slider.createLoop();
											var t = o.__slider.slides.length;
											t > 10 && (e.showPager = !1),
												o.__slider.activeIndex > t - 1 &&
													o.__slider.slideTo(t - 1);
										}
									});
								}),
								...
								(this._options = a),
									t(function() {
										...
										e.$emit("$ionicSlides.sliderInitialized", { slider: t }),
											(o.__slider = t),
											(e.slider = o.__slider),
											e.$on("$destroy", function() {
				...
				return {
					...
					compile: function(r, a) {
						for (
							var c =
									"<ion-tab-nav" +
									o("ng-click", a.ngClick) +
									o("title", a.title) +
									o("icon", a.icon) +
									o("icon-on", a.iconOn) +
									o("icon-off", a.iconOff) +
									o("badge", a.badge) +
									o("badge-style", a.badgeStyle) +
									o("hidden", a.hidden) +
									o("disabled", a.disabled) +
									o("class", a["class"]) +
									"></ion-tab-nav>",
								s = document.createElement("div"),
								l = 0;
							l < r[0].children.length;
							l++
						)
						...
						return (
							u &&
								("ION-NAV-VIEW" === s.children[0].tagName &&
									((d = s.children[0].getAttribute("name")),
									s.children[0].classList.add("view-container"),
									(h = !0)),
								1 === u && (s = s.children[0]),
								h || s.classList.add("pane"),
							...
							function(o, r, a, l) {
								...
								function p(n) {
									n && u
										...
										: b &&
											m &&
											(t.views.maxCache() > 0 ? i.viewEleIsActive(m, !1) : v());
								}
								function v() {
									g && g.$destroy(),
										b && m && m.remove(),
								...
								y.data("$ionTabsController", $),
									...
									o.$on("$ionicView.afterEnter", function() {
			...
			function() {
				return {
					...
					template:
						...
						' ng-disabled="disabled()" class="tab-item"><span class="badge {{badgeStyle}}" ng-if="badge">{{badge}}</span><i class="icon {{getIcon()}}" ng-if="getIcon()"></i><span class="tab-title" ng-bind-html="title"></span></a>',
					scope: {
						title: "@",
						icon: "@",
						iconOn: "@",
				...
				return {
					...
					compile: function(n) {
						function i(t, n, i, o) {
							...
							(o.$scope = t),
								(o.$element = n),
								(o.$tabsElement = f(n[0].querySelector(".tabs"))),
								t.$watch(
									function() {
										return n[0].className;
									},
						...
						return (
							...
							n
								.append(r)
								.addClass(
									"tabs-" + t.tabs.position() + " tabs-" + t.tabs.style()
								),
							{ pre: i, post: o }
						);
					}
		...
		a.directive("ionToggle", [
			...
			function(e, t) {
				return {
					...
					transclude: !0,
					template:
						'<div class="item item-toggle"><div ng-transclude></div><label class="toggle"><input type="checkbox"><div class="track"><div class="handle"></div></div></label></div>',
