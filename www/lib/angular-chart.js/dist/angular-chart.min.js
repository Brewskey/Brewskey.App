!(function(t) {
	...
	function r(n, r) {
		...
		function l(r, a) {
			for (
				...
				i.length < a.data.length;

			)
				i.push(a.getColour()), (o = !0);
			return o && (a.colours = i), i.map(u);
		}
		function u(t) {
				...
				link: function(i, u) {
					...
					function d(e) {
						...
						if (i.data && i.data.length) {
							i.getColour = "function" == typeof i.getColour ? i.getColour : s;
							var a = l(e, i),
								o = u[0],
								f = o.getContext("2d"),
								h = Array.isArray(i.data[0])
									? p(i.labels, i.data, i.series || [], a)
									: v(i.labels, i.data, a),
								g = t.extend({}, n.getOptions(e), i.options);
							(w = new n.Chart(f)[e](h, g)),
								i.$emit("create", w),
								(o.onclick = i.click ? c(i, w, "click", !1) : t.noop),
								(o.onmousemove = i.hover ? c(i, w, "hover", !0) : t.noop),
								i.legend && "false" !== i.legend && y(u, w);
						}
					}
					function g(t) {
						if (
					...
					(A.className = "chart-container"),
						...
						f("chartData", "data"),
						f("chartLabels", "labels"),
						f("chartOptions", "options"),
						f("chartSeries", "series"),
						f("chartColours", "colours"),
						f("chartLegend", "legend"),
						f("chartClick", "click"),
						f("chartHover", "hover"),
						i.$watch(
							"data",
						...
						i.$watch("options", h, !0),
						i.$watch("colours", h, !0),
						i.$watch("chartType", function(e, n) {
	...
	(e.defaults.global.responsive = !0),
		(e.defaults.global.multiTooltipTemplate =
			"<%if (datasetLabel){%><%=datasetLabel%>: <%}%><%= value %>"),
		(e.defaults.global.colours = [
			"#97BBCD",
			"#DCDCDC",
			"#F7464A",
			"#46BFBD",
	...
	return (
		a && (e.defaults.global.animation = !1),
		t
			.module("chart.js", [])
			.provider("ChartJs", n)
