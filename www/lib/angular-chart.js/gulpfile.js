(function() {
	...
	gulp.task("unit", function() {
		return gulp.src("test/index.html", { read: false }).pipe(
			mochaPhantomJS({
				phantomjs: {
	...
	gulp.task("integration", function() {
		return gulp
			.src(path.join("test", "test.integration.js"), { read: false })
			.pipe(
				mocha({
					reporter: "list",
					timeout: 20000,
	...
	gulp.task("bower", function() {
		return gulp.src("./angular-chart.js").pipe(gulp.dest("./dist"));
	});
	...
	gulp.task(
		"deploy-minor",
		sequence("default", "bump-minor", "update", "git-commit", "git-push", "npm")
	);
	gulp.task(
		"deploy-major",
		sequence("default", "bump-patch", "update", "git-commit", "git-push", "npm")
