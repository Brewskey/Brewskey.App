...
var Zepto = (function() {
	...
	function z(t) {
		return k(t) && !Z(t) && Object.getPrototypeOf(t) == Object.prototype;
	}
	function q(t) {
	...
	return (
			...
			return (
				...
				z(r) &&
					...
					n.each(r, function(t, e) {
						v.indexOf(t) > -1 ? u[t](e) : u.attr(t, e);
					})),
				s
			);
		}),
		...
		(C.init = function(e, i) {
			...
			if ("string" == typeof e)
				...
				if (L(e)) return n(a).ready(e);
				if (C.isZ(e)) return e;
				if (A(e)) r = R(e);
				else if (k(e)) (r = [e]), (e = null);
				else if (l.test(e))
		...
		(n.fn = {
			...
			closest: function(t, e) {
				...
				for (
					...
					i && !(r ? r.indexOf(i) >= 0 : C.matches(i, t));
			...
			parents: function(t) {
				for (var e = [], i = this; i.length > 0; )
					i = n.map(i, function(t) {
						return (t = t.parentNode) && !D(t) && e.indexOf(t) < 0
							? (e.push(t), t)
							: void 0;
					});
				return X(e, t);
			...
			parent: function(t) {
				return X(S(this.pluck("parentNode")), t);
			},
			children: function(t) {
				return X(
					this.map(function() {
			...
			attr: function(n, i) {
				...
				return "string" == typeof n && i === t
					...
					: this.each(function(t) {
							if (1 === this.nodeType)
								if (k(n)) for (e in n) J(this, e, n[e]);
								else J(this, n, B(this, i, t, this.getAttribute(n)));
						});
			},
			removeAttr: function(t) {
				return this.each(function() {
					1 === this.nodeType && J(this, t);
				});
			},
			prop: function(e, n) {
				return (
			...
			css: function(t, i) {
				if (arguments.length < 2) {
					...
					if (!r) return;
					if ("string" == typeof t)
						return r.style[N(t)] || o.getPropertyValue(t);
					if (A(t)) {
						var s = {};
						return (
							n.each(A(t) ? t : [t], function(t, e) {
								s[e] = r.style[N(e)] || o.getPropertyValue(e);
							}),
							s
						);
					}
				...
				return r === t
					? Z(s)
						...
						: D(s)
							...
							: (o = this.offset()) && o[e]
					: this.each(function(t) {
							(s = n(this)), s.css(e, B(this, r, t, s[e]()));
						});
			};
		}),
			...
			(n.fn[t] = function() {
				var t,
					...
					r = n.map(arguments, function(e) {
						return (
							(t = $(e)),
							"object" == t || "array" == t || null == e ? e : C.fragment(e)
						);
					}),
					s = this.length > 1;
				return r.length < 1
...
(window.Zepto = Zepto),
			...
			i.split(/\s/).forEach(function(i) {
				...
				(s.proxy = function(t) {
					...
					"addEventListener" in e &&
						e.addEventListener(v(s.e), s.proxy, m(s, f));
			});
		}
					...
					(d.onreadystatechange = function() {
						if (4 == d.readyState) {
							...
							if (
								...
								i ? g(i, "parsererror", d, n, o) : v(e, d, n, o);
							} else
								g(d.statusText || null, d.status ? "error" : "abort", d, n, o);
						}
					}),
					m(d, n) === !1)
				)
					return d.abort(), g(null, "abort", d, n, o), d;
	...
	(function(t, e) {
		...
		t.each(s, function(t, r) {
			return u.style[t + "TransitionProperty"] !== e
				? ((n = "-" + t.toLowerCase() + "-"), (i = r), !1)
				: void 0;
		}),
			(c = n + "transform"),
			(x[(l = n + "transition-property")] = x[
				(h = n + "transition-duration")
			] = x[(d = n + "transition-delay")] = x[
				(p = n + "transition-timing-function")
			] = x[(m = n + "animation-name")] = x[(v = n + "animation-duration")] = x[
				(y = n + "animation-delay")
			] = x[(g = n + "animation-timing-function")] = ""),
			(t.fx = {
			...
			(t.fn.animate = function(n, i, r, o, s) {
				return (
					...
					t.isPlainObject(i) &&
						((r = i.easing), (o = i.complete), (s = i.delay), (i = i.duration)),
					i &&
						(i =
							("number" == typeof i
								? i
			...
			(t.fn.anim = function(n, i, r, o, s) {
				var a,
					...
					N = !1;
				if (
					(i === e && (i = t.fx.speeds._default / 1e3),
					s === e && (s = 0),
					t.fx.off && (i = 0),
					"string" == typeof n)
				)
				...
				return (
					(T = function(e) {
						if ("undefined" != typeof e) {
							...
							t(e.target).unbind(C, T);
						} else t(this).unbind(C, T);
						(N = !0), t(this).css(x), o && o.call(this);
					}),
					i > 0 &&
						(this.bind(C, T),
						setTimeout(function() {
		...
		(e.qsa = function(i, r) {
			return f(r, function(o, s, f) {
				try {
					...
					!o && s
						? (o = "*")
						: a.test(o) && ((c = t(i).addClass(u)), (o = "." + u + " " + o));
					var l = n(i, o);
				} catch (h) {
			...
			return (
				t.each(e.attributes || o, function(e, r) {
					0 == r.name.indexOf("data-") &&
						(n[i(r.name.replace("data-", ""))] = t.zepto.deserializeValue(
							r.value
						));
				}),
				n
		...
		(t.fn.data = function(e, n) {
			return void 0 === n
				? t.isPlainObject(e)
					...
					: 0 == this.length ? void 0 : s(this[0], e)
				: this.each(function() {
						a(this, e, n);
					});
		}),
