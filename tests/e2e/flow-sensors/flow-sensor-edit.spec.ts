...
test.describe('with a standard flow sensor', () => {
  test.use({ seed: { taps: [{ flowSensor: 'Titan' }] } });

  test('should navigate to edit flow sensor', async ({ page, taps }) => {
    const [tap] = taps;
  ...
  test('should successfully update standard flow sensor', async ({
    page,
    taps,
  }) => {
    const [tap] = taps;
...
test.describe('with a custom flow sensor', () => {
  test.use({ seed: { taps: [{ flowSensor: 'Custom' }] } });
  ...
  test('should successfully update custom flow sensor', async ({
    page,
    taps,
  }) => {
    const [tap] = taps;
