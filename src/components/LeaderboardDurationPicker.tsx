...
export const LEADERBOARD_DURATION_OPTIONS: Partial<Record<DurationKeys, LeaderboardDurationOptions>> = {
...
type Props = {
  value: LeaderboardDurationValue,
  onChange: (value?: LeaderboardDurationValue | null | undefined) => void
};
...
): React.ReactElement => <SimplePicker
